...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(e,t,n){let r=new Float32Array(To),i=new G(0,1,0);return new na({name:`SphericalGaussianBlur`,defines:{n:To,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bo(){return new na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(){return new na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
	...
	`}var Uo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Li(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,vl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new Vi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new na({vertexShader:gl,fragmentShader:_l,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Y(new Gi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},yl=class extends $e{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new vl,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new W,O=null,k=new Pa;k.viewport=new Ht;let te=new Pa;te.viewport=new Ht;let A=[k,te],j=new Wa,ne=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new wn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new wn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new wn,C[e]=t),t.getHandSpace()};function N(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function re(){r.removeEventListener(`select`,N),r.removeEventListener(`selectstart`,N),r.removeEventListener(`selectend`,N),r.removeEventListener(`squeeze`,N),r.removeEventListener(`squeezestart`,N),r.removeEventListener(`squeezeend`,N),r.removeEventListener(`end`,re),r.removeEventListener(`inputsourceschange`,ie);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,M=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,de.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&B(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&B(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,N),r.addEventListener(`selectstart`,N),r.addEventListener(`selectend`,N),r.addEventListener(`squeeze`,N),r.addEventListener(`squeezestart`,N),r.addEventListener(`squeezeend`,N),r.addEventListener(`end`,re),r.addEventListener(`inputsourceschange`,ie),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Wt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new zi(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Wt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),de.setContext(r),de.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ie(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let ae=new G,oe=new G;function se(e,t,n){ae.setFromMatrixPosition(t.matrixWorld),oe.setFromMatrixPosition(n.matrixWorld);let r=ae.distanceTo(oe),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function ce(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||M!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,M=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;ce(j,i);for(let e=0;e<a.length;e++)ce(a[e],i);a.length===2?se(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),le(e,j,i)};function le(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=rt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let P=null;function ue(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new Pa,o.layers.enable(n),o.viewport=new Ht,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new Vi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}P&&P(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let de=new fo;de.setAnimationLoop(ue),this.setAnimationLoop=function(e){P=e},this.dispose=function(){}}},bl=new qt,xl=new K;xl.set(-1,0,0,0,1,0,0,0,1);function Sl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Qi(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(bl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(xl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Cl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return V(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?B(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):B(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var wl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Tl=null;function El(){return Tl===null&&(Tl=new hi(wl,16,16,O,g),Tl.name=`DFG_LUT`,Tl.minFilter=o,Tl.magFilter=o,Tl.wrapS=t,Tl.wrapT=t,Tl.generateMipmaps=!1,Tl.needsUpdate=!0),Tl}var Dl=class{constructor(e={}){let{canvas:t=Ke(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new G,O=null,A=null,j=[],ne=[],M=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let N=this,re=!1,ie=null,ae=null,oe=null,se=null;this._outputColorSpace=Le;let ce=0,le=0,P=null,ue=-1,de=null,fe=new Ht,pe=new Ht,me=null,he=new J(0),ge=0,_e=t.width,ve=t.height,ye=1,be=null,xe=null,Se=new Ht(0,0,_e,ve),Ce=new Ht(0,0,_e,ve),we=!1,Te=new Ci,Ee=!1,De=!1,Oe=new qt,ke=new G,Ae=new Ht,je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Me=!1;function Ne(){return P===null?ye:1}let F=n;function Pe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,ot,!1),t.addEventListener(`webglcontextrestored`,st,!1),t.addEventListener(`webglcontextcreationerror`,ct,!1),F===null){let t=`webgl2`;if(F=Pe(t,e),F===null)throw Pe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw V(`WebGLRenderer: `+e.message),e}let I,Fe,L,Ie,R,z,Re,ze,Be,Ve,Ue,We,Ge,qe,Ye,Xe,Qe,$e,et,tt,nt,rt,it;function H(){I=new Go(F),I.init(),nt=new hl(F,I),Fe=new xo(F,I,e,nt),L=new pl(F,I),Fe.reversedDepthBuffer&&h&&L.buffers.depth.setReversed(!0),ae=F.createFramebuffer(),oe=F.createFramebuffer(),se=F.createFramebuffer(),Ie=new Jo(F),R=new qc,z=new ml(F,I,L,R,Fe,nt,Ie),Re=new Wo(N),ze=new po(F),rt=new yo(F,ze),Be=new Ko(F,ze,Ie,rt),Ve=new Xo(F,Be,ze,rt,Ie),$e=new Yo(F,Fe,z),Ye=new So(R),Ue=new Kc(N,Re,I,Fe,rt,Ye),We=new Sl(N,R),Ge=new Zc,qe=new il(I),Qe=new vo(N,Re,L,Ve,x,s),Xe=new fl(N,Ve,Fe),it=new Cl(F,Ie,Fe,L),et=new bo(F,I,Ie),tt=new qo(F,I,Ie),Ie.programs=Ue.programs,N.capabilities=Fe,N.extensions=I,N.properties=R,N.renderLists=Ge,N.shadowMap=Xe,N.state=L,N.info=Ie}H(),S!==1009&&(M=new Qo(S,t.width,t.height,o,r,i));let at=new yl(N,F);this.xr=at,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let e=I.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=I.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ye},this.setPixelRatio=function(e){e!==void 0&&(ye=e,this.setSize(_e,ve,!1))},this.getSize=function(e){return e.set(_e,ve)},this.setSize=function(e,n,r=!0){if(at.isPresenting){B(`WebGLRenderer: Can't change size while VR device is presenting.`);return}_e=e,ve=n,t.width=Math.floor(e*ye),t.height=Math.floor(n*ye),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),M!==null&&M.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(_e*ye,ve*ye).floor()},this.setDrawingBufferSize=function(e,n,r){_e=e,ve=n,ye=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){V(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){B(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}M.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(fe)},this.getViewport=function(e){return e.copy(Se)},this.setViewport=function(e,t,n,r){e.isVector4?Se.set(e.x,e.y,e.z,e.w):Se.set(e,t,n,r),L.viewport(fe.copy(Se).multiplyScalar(ye).round())},this.getScissor=function(e){return e.copy(Ce)},this.setScissor=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),L.scissor(pe.copy(Ce).multiplyScalar(ye).round())},this.getScissorTest=function(){return we},this.setScissorTest=function(e){L.setScissorTest(we=e)},this.setOpaqueSort=function(e){be=e},this.setTransparentSort=function(e){xe=e},this.getClearColor=function(e){return e.copy(Qe.getClearColor())},this.setClearColor=function(){Qe.setClearColor(...arguments)},this.getClearAlpha=function(){return Qe.getClearAlpha()},this.setClearAlpha=function(){Qe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(P!==null){let t=P.texture.format;e=C.has(t)}if(e){let e=P.texture.type,t=w.has(e),n=Qe.getClearColor(),r=Qe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,F.clearBufferuiv(F.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,F.clearBufferiv(F.COLOR,0,E))}else r|=F.COLOR_BUFFER_BIT}t&&(r|=F.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&F.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ie=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ot,!1),t.removeEventListener(`webglcontextrestored`,st,!1),t.removeEventListener(`webglcontextcreationerror`,ct,!1),Qe.dispose(),Ge.dispose(),qe.dispose(),R.dispose(),Re.dispose(),Ve.dispose(),rt.dispose(),it.dispose(),Ue.dispose(),at.dispose(),at.removeEventListener(`sessionstart`,ht),at.removeEventListener(`sessionend`,gt),_t.stop()};function ot(e){e.preventDefault(),Je(`WebGLRenderer: Context Lost.`),re=!0}function st(){Je(`WebGLRenderer: Context Restored.`),re=!1;let e=Ie.autoReset,t=Xe.enabled,n=Xe.autoUpdate,r=Xe.needsUpdate,i=Xe.type;H(),Ie.autoReset=e,Xe.enabled=t,Xe.autoUpdate=n,Xe.needsUpdate=r,Xe.type=i}function ct(e){V(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function lt(e){let t=e.target;t.removeEventListener(`dispose`,lt),ut(t)}function ut(e){dt(e),R.remove(e)}function dt(e){let t=R.get(e).programs;t!==void 0&&(t.forEach(function(e){Ue.releaseProgram(e)}),e.isShaderMaterial&&Ue.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=je);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Tt(e,t,n,r,i);L.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Be.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;rt.setup(i,r,s,n,c);let h,g=et;if(c!==null&&(h=ze.get(c),g=tt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(L.setLineWidth(r.wireframeLinewidth*Ne()),g.setMode(F.LINES)):g.setMode(F.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),L.setLineWidth(e*Ne()),i.isLineSegments?g.setMode(F.LINES):i.isLineLoop?g.setMode(F.LINE_LOOP):g.setMode(F.LINE_STRIP)}else i.isPoints?g.setMode(F.POINTS):i.isSprite&&g.setMode(F.TRIANGLES);if(i.isBatchedMesh){if(I.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?ze.get(c).bytesPerElement:1,o=R.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(F,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function ft(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Ct(e,t,n),e.side=0,e.needsUpdate=!0,Ct(e,t,n),e.side=2):Ct(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=qe.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];ft(a,n,e),r.add(a)}else ft(t,n,e),r.add(t)}}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){R.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}I.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let pt=null;function mt(e){pt&&pt(e)}function ht(){_t.stop()}function gt(){_t.start()}let _t=new fo;_t.setAnimationLoop(mt),typeof self<`u`&&_t.setContext(self),this.setAnimationLoop=function(e){pt=e,at.setAnimationLoop(e),e===null?_t.stop():_t.start()},at.addEventListener(`sessionstart`,ht),at.addEventListener(`sessionend`,gt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){V(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(re===!0)return;ie!==null&&ie.renderStart(e,t);let n=at.enabled===!0&&at.isPresenting===!0,r=M!==null&&(P===null||n)&&M.begin(N,P);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),at.enabled===!0&&at.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(at.cameraAutoUpdate===!0&&at.updateCamera(t),t=at.getCamera()),e.isScene===!0&&e.onBeforeRender(N,e,t,P),A=qe.get(e,ne.length),A.init(t),A.state.textureUnits=z.getTextureUnits(),ne.push(A),Oe.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Te.setFromProjectionMatrix(Oe,He,t.reversedDepth),De=this.localClippingEnabled,Ee=Ye.init(this.clippingPlanes,De),O=Ge.get(e,j.length),O.init(),j.push(O),at.enabled===!0&&at.isPresenting===!0){let e=N.xr.getDepthSensingMesh();e!==null&&vt(e,t,-1/0,N.sortObjects)}vt(e,t,0,N.sortObjects),O.finish(),N.sortObjects===!0&&O.sort(be,xe,t.reversedDepth),Me=at.enabled===!1||at.isPresenting===!1||at.hasDepthSensing()===!1,Me&&Qe.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ee===!0&&Ye.beginShadows();let i=A.state.shadowsArray;if(Xe.render(i,e,t),Ee===!0&&Ye.endShadows(),(r&&M.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];bt(n,r,e,a)}Me&&Qe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];yt(O,e,n,n.viewport)}}else r.length>0&&bt(n,r,e,t),Me&&Qe.render(e),yt(O,e,t)}P!==null&&le===0&&(z.updateMultisampleRenderTarget(P),z.updateRenderTargetMipmap(P)),r&&M.end(N),e.isScene===!0&&e.onAfterRender(N,e,t),rt.resetDefaultState(),ue=-1,de=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],z.setTextureUnits(A.state.textureUnits),Ee===!0&&Ye.setGlobalState(N.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ie!==null&&ie.renderEnd()};function vt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Te.intersectsSprite(e)){r&&Ae.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Oe);let t=Ve.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Ae.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Te.intersectsObject(e))){let t=Ve.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ae.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ae.copy(e.boundingSphere.center)),Ae.applyMatrix4(e.matrixWorld).applyMatrix4(Oe)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Ae.z,o)}}else i.visible&&O.push(e,t,i,n,Ae.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)vt(i[e],t,n,r)}function yt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),Ee===!0&&Ye.setGlobalState(N.clippingPlanes,n),r&&L.viewport(fe.copy(r)),i.length>0&&xt(i,t,n),a.length>0&&xt(a,t,n),o.length>0&&xt(o,t,n),L.buffers.depth.setTest(!0),L.buffers.depth.setMask(!0),L.buffers.color.setMask(!0),L.setPolygonOffset(!1)}function bt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=I.has(`EXT_color_buffer_half_float`)||I.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new Wt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Fe.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:q.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||fe;a.setSize(o.z*N.transmissionResolutionScale,o.w*N.transmissionResolutionScale);let s=N.getRenderTarget(),u=N.getActiveCubeFace(),d=N.getActiveMipmapLevel();N.setRenderTarget(a),N.getClearColor(he),ge=N.getClearAlpha(),ge<1&&N.setClearColor(16777215,.5),N.clear(),Me&&Qe.render(n);let f=N.toneMapping;N.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),Ee===!0&&Ye.setGlobalState(N.clippingPlanes,r),xt(e,n,r),z.updateMultisampleRenderTarget(a),z.updateRenderTargetMipmap(a),I.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,St(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(z.updateMultisampleRenderTarget(a),z.updateRenderTargetMipmap(a))}N.setRenderTarget(s,u,d),N.setClearColor(he,ge),p!==void 0&&(r.viewport=p),N.toneMapping=f}function xt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&St(o,t,n,s,l,c)}}function St(e,t,n,r,i,a){e.onBeforeRender(N,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(N,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,N.renderBufferDirect(n,t,r,i,e,a),i.side=2):N.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(N,t,n,r,i,a)}function Ct(e,t,n){t.isScene!==!0&&(t=je);let r=R.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Ue.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Ue.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Re.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,lt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return wt(e,s),d}else s.uniforms=Ue.getUniforms(e),ie!==null&&e.isNodeMaterial&&ie.build(e,n,s),e.onBeforeCompile(s,N),d=Ue.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ye.uniform),wt(e,s),r.needsLights=Dt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function U(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=ac.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function wt(e,t){let n=R.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function W(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Tt(e,t,n,r,i){t.isScene!==!0&&(t=je),z.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=P===null?N.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:q.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Re.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(h=N.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=R.get(r),y=A.state.lights;if(Ee===!0&&(De===!0||e!==de)){let t=e===de&&r.id===ue;Ye.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ye.numPlanes||v.numIntersection!==Ye.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Ct(r,t,i),ie&&r.isNodeMaterial&&ie.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(L.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ue&&(ue=r.id,C=!0),v.needsLights){let e=W(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||de!==e){L.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(F,`projectionMatrix`,e.projectionMatrix),T.setValue(F,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(F,ke.setFromMatrixPosition(e.matrixWorld)),Fe.logarithmicDepthBuffer&&T.setValue(F,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(F,`isOrthographic`,e.isOrthographicCamera===!0),de!==e&&(de=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(F,`directionalShadowMap`,y.state.directionalShadowMap,z),y.state.spotShadowMap.length>0&&T.setValue(F,`spotShadowMap`,y.state.spotShadowMap,z),y.state.pointShadowMap.length>0&&T.setValue(F,`pointShadowMap`,y.state.pointShadowMap,z)),i.isSkinnedMesh){T.setOptional(F,i,`bindMatrix`),T.setOptional(F,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(F,`boneTexture`,e.boneTexture,z))}i.isBatchedMesh&&(T.setOptional(F,i,`batchingTexture`),T.setValue(F,`batchingTexture`,i._matricesTexture,z),T.setOptional(F,i,`batchingIdTexture`),T.setValue(F,`batchingIdTexture`,i._indirectTexture,z),T.setOptional(F,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(F,`batchingColorTexture`,i._colorsTexture,z));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&$e.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(F,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=El()),C){if(T.setValue(F,`toneMappingExposure`,N.toneMappingExposure),v.needsLights&&Et(E,w),a&&r.fog===!0&&We.refreshFogUniforms(E,a),We.refreshMaterialUniforms(E,r,ye,ve,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}ac.upload(F,U(v),E,z)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(ac.upload(F,U(v),E,z),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(F,`center`,i.center),T.setValue(F,`modelViewMatrix`,i.modelViewMatrix),T.setValue(F,`normalMatrix`,i.normalMatrix),T.setValue(F,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];it.update(n,x),it.bind(n,x)}}return x}function Et(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Dt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ce},this.getActiveMipmapLevel=function(){return le},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(e,t,n){let r=R.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),R.get(e.texture).__webglTexture=t,R.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=R.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){P=e,ce=t,le=n;let r=null,i=!1,a=!1;if(e){let o=R.get(e);if(o.__useDefaultFramebuffer!==void 0){L.bindFramebuffer(F.FRAMEBUFFER,o.__webglFramebuffer),fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest,L.viewport(fe),L.scissor(pe),L.setScissorTest(me),ue=-1;return}if(o.__webglFramebuffer===void 0)z.setupRenderTarget(e);else if(o.__hasExternalTextures)z.rebindTextures(e,R.get(e.texture).__webglTexture,R.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&R.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);z.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=R.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&z.useMultisampledRTT(e)===!1?R.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,fe.copy(e.viewport),pe.copy(e.scissor),me=e.scissorTest}else fe.copy(Se).multiplyScalar(ye).floor(),pe.copy(Ce).multiplyScalar(ye).floor(),me=we;if(n!==0&&(r=ae),L.bindFramebuffer(F.FRAMEBUFFER,r)&&L.drawBuffers(e,r),L.viewport(fe),L.scissor(pe),L.setScissorTest(me),i){let r=R.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=R.get(e.textures[t]);F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=R.get(e.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,t.__webglTexture,n)}ue=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=R.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){L.bindFramebuffer(F.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!Fe.textureFormatReadable(c)){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Fe.textureTypeReadable(l)){V(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&F.readPixels(t,n,r,i,nt.convert(c),nt.convert(l),a)}finally{let e=P===null?null:R.get(P).__webglFramebuffer;L.bindFramebuffer(F.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=R.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){L.bindFramebuffer(F.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&F.readBuffer(F.COLOR_ATTACHMENT0+s),!Fe.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Fe.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.bufferData(F.PIXEL_PACK_BUFFER,a.byteLength,F.STREAM_READ),F.readPixels(t,n,r,i,nt.convert(l),nt.convert(u),0);let f=P===null?null:R.get(P).__webglFramebuffer;L.bindFramebuffer(F.FRAMEBUFFER,f);let p=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Ze(F,p,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,d),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,a),F.deleteBuffer(d),F.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;z.setTexture2D(e,0),F.copyTexSubImage2D(F.TEXTURE_2D,n,0,0,o,s,i,a),L.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=nt.convert(t.format),_=nt.convert(t.type),v;t.isData3DTexture?(z.setTexture3D(t,0),v=F.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(z.setTexture2DArray(t,0),v=F.TEXTURE_2D_ARRAY):(z.setTexture2D(t,0),v=F.TEXTURE_2D),L.activeTexture(F.TEXTURE0),L.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,t.flipY),L.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),L.pixelStorei(F.UNPACK_ALIGNMENT,t.unpackAlignment);let y=L.getParameter(F.UNPACK_ROW_LENGTH),b=L.getParameter(F.UNPACK_IMAGE_HEIGHT),x=L.getParameter(F.UNPACK_SKIP_PIXELS),S=L.getParameter(F.UNPACK_SKIP_ROWS),C=L.getParameter(F.UNPACK_SKIP_IMAGES);L.pixelStorei(F.UNPACK_ROW_LENGTH,h.width),L.pixelStorei(F.UNPACK_IMAGE_HEIGHT,h.height),L.pixelStorei(F.UNPACK_SKIP_PIXELS,l),L.pixelStorei(F.UNPACK_SKIP_ROWS,u),L.pixelStorei(F.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=R.get(e),r=R.get(t),h=R.get(n.__renderTarget),g=R.get(r.__renderTarget);L.bindFramebuffer(F.READ_FRAMEBUFFER,h.__webglFramebuffer),L.bindFramebuffer(F.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,R.get(e).__webglTexture,i,d+n),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,R.get(t).__webglTexture,a,m+n)),F.blitFramebuffer(l,u,o,s,f,p,o,s,F.DEPTH_BUFFER_BIT,F.NEAREST);L.bindFramebuffer(F.READ_FRAMEBUFFER,null),L.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||R.has(e)){let n=R.get(e),r=R.get(t);L.bindFramebuffer(F.READ_FRAMEBUFFER,oe),L.bindFramebuffer(F.DRAW_FRAMEBUFFER,se);for(let e=0;e<c;e++)w?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,n.__webglTexture,i),T?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,r.__webglTexture,a),i===0?T?F.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):F.copyTexSubImage2D(v,a,f,p,l,u,o,s):F.blitFramebuffer(l,u,o,s,f,p,o,s,F.COLOR_BUFFER_BIT,F.NEAREST);L.bindFramebuffer(F.READ_FRAMEBUFFER,null),L.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?F.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):F.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):F.texSubImage2D(F.TEXTURE_2D,a,f,p,o,s,g,_,h);L.pixelStorei(F.UNPACK_ROW_LENGTH,y),L.pixelStorei(F.UNPACK_IMAGE_HEIGHT,b),L.pixelStorei(F.UNPACK_SKIP_PIXELS,x),L.pixelStorei(F.UNPACK_SKIP_ROWS,S),L.pixelStorei(F.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&F.generateMipmap(v),L.unbindTexture()},this.initRenderTarget=function(e){R.get(e).__webglFramebuffer===void 0&&z.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?z.setTextureCube(e,0):e.isData3DTexture?z.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?z.setTexture2DArray(e,0):z.setTexture2D(e,0),L.unbindTexture()},this.resetState=function(){ce=0,le=0,P=null,L.reset(),rt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return He}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=q._getDrawingBufferColorSpace(e),t.unpackColorSpace=q._getUnpackColorSpace()}},Q={MAP_WIDTH:2400,MAP_HEIGHT:1800,DEFAULT_VISION:9,TILE_SIZE:32,ENEMY_AGGRO_RADIUS:5.5,ENEMY_LEASH_DISTANCE:15,AI_RETARGET_INTERVAL:400,CAMERA_EDGE_PAN_PERCENT:2.5,CAMERA_EDGE_PAN_MIN:12,CAMERA_EDGE_PAN_MAX:28,CAMERA_PAN_SPEED:70,CAMERA_ZOOM_MIN:.65,CAMERA_ZOOM_MAX:1.35,CAMERA_ZOOM_STEP:.08,CAMERA_MARGIN_PERCENT:5,FOG_EXPLORED_ALPHA:.45,FOG_REFRESH_INTERVAL:125,FOG_UNEXPLORED_COLOR:0,FOG_EXPLORED_COLOR:662026,MAX_CONTROL_GROUPS:10,UNIT_SIZE:30,STARTING_BIOMASS:100,STARTING_DNA:80,STARTING_WORKERS:2,WORKER_COST_DNA:30,WORKER_COST_BIOMASS:40,WORKER_GATHER_RATE:8,WORKER_GATHER_INTERVAL:4e3,WORKER_SPEED:1.5,DNA_TRICKLE_RATE:2,DNA_TRICKLE_INTERVAL:5e3,RESOURCE_NODE_BIOMASS_AMOUNT:2e3,HQ_HP:500,HQ_SIZE:60},Ol=class{camera;target;domElement;keys={w:!1,a:!1,s:!1,d:!1,arrowUp:!1,arrowDown:!1,arrowLeft:!1,arrowRight:!1};mouseAtEdge={x:0,y:0};pointerInWindow=!0;PAN_SPEED=Q.CAMERA_PAN_SPEED/1e3;MIN_HEIGHT=30;MAX_HEIGHT=100;CAMERA_ANGLE=50;helpOverlayOpen=!1;MAP_WIDTH=Q.MAP_WIDTH;MAP_HEIGHT=Q.MAP_HEIGHT;constructor(e){this.domElement=e,this.camera=new Pa(50,window.innerWidth/window.innerHeight,1,1e3),this.target=new G(this.MAP_WIDTH/2,0,this.MAP_HEIGHT/2),this.updateCameraPosition(60),this.setupControls()}frameView(e,t,n=55){this.target.set(e,0,t),this.updateCameraPosition(n)}setupControls(){window.addEventListener(`keydown`,this.onKeyDown.bind(this)),window.addEventListener(`keyup`,this.onKeyUp.bind(this)),this.domElement.addEventListener(`wheel`,this.onWheel.bind(this),{passive:!1}),this.domElement.addEventListener(`pointermove`,this.onPointerMove.bind(this)),this.domElement.addEventListener(`pointerleave`,()=>{this.pointerInWindow=!1}),this.domElement.addEventListener(`pointerenter`,()=>{this.pointerInWindow=!0}),window.addEventListener(`blur`,()=>{this.pointerInWindow=!1})}onKeyDown(e){switch(e.code){case`KeyW`:this.keys.w=!0,e.preventDefault();break;case`KeyA`:this.keys.a=!0,e.preventDefault();break;case`KeyS`:this.keys.s=!0,e.preventDefault();break;case`KeyD`:this.keys.d=!0,e.preventDefault();break;case`ArrowUp`:this.keys.arrowUp=!0;break;case`ArrowDown`:this.keys.arrowDown=!0;break;case`ArrowLeft`:this.keys.arrowLeft=!0;break;case`ArrowRight`:this.keys.arrowRight=!0}}onKeyUp(e){switch(e.code){case`KeyW`:this.keys.w=!1;break;case`KeyA`:this.keys.a=!1;break;case`KeyS`:this.keys.s=!1;break;case`KeyD`:this.keys.d=!1;break;case`ArrowUp`:this.keys.arrowUp=!1;break;case`ArrowDown`:this.keys.arrowDown=!1;break;case`ArrowLeft`:this.keys.arrowLeft=!1;break;case`ArrowRight`:this.keys.arrowRight=!1}}onWheel(e){e.preventDefault();let t=this.screenToWorld(e.clientX,e.clientY),n=this.camera.position.y,r=e.deltaY>0?3:-3,i=wt.clamp(n+r,this.MIN_HEIGHT,this.MAX_HEIGHT);this.updateCameraPosition(i);let a=this.screenToWorld(e.clientX,e.clientY);if(t&&a){let e=new G().subVectors(t,a);this.target.add(e),this.target.x=wt.clamp(this.target.x,20,this.MAP_WIDTH-20),this.target.z=wt.clamp(this.target.z,20,this.MAP_HEIGHT-20),this.updateCameraPosition(i)}}screenToWorld(e,t){let n=this.domElement.getBoundingClientRect(),r=new W((e-n.left)/n.width*2-1,-((t-n.top)/n.height)*2+1),i=new io;i.setFromCamera(r,this.camera);let a=new yi(new G(0,1,0),0),o=new G;return i.ray.intersectPlane(a,o),o||null}onPointerMove(e){if(!this.pointerInWindow)return;let t=this.domElement.getBoundingClientRect(),n=Math.max(12,Math.min(28,t.width*.025));this.mouseAtEdge.x=0,this.mouseAtEdge.y=0,e.clientX-t.left<n?this.mouseAtEdge.x=-1:t.right-e.clientX<n&&(this.mouseAtEdge.x=1),e.clientY-t.top<n?this.mouseAtEdge.y=-1:t.bottom-e.clientY<n&&(this.mouseAtEdge.y=1)}updateCameraPosition(e){let t=this.CAMERA_ANGLE*Math.PI/180,n=e/Math.sin(t)*Math.cos(t);this.camera.position.set(this.target.x,e,this.target.z+n),this.camera.lookAt(this.target)}update(e){let t=this.PAN_SPEED*e,n=!1;(this.keys.w||this.keys.arrowUp)&&(this.target.z-=t,n=!0),(this.keys.s||this.keys.arrowDown)&&(this.target.z+=t,n=!0),(this.keys.a||this.keys.arrowLeft)&&(this.target.x-=t,n=!0),(this.keys.d||this.keys.arrowRight)&&(this.target.x+=t,n=!0),this.pointerInWindow&&!this.helpOverlayOpen&&(this.mouseAtEdge.x!==0&&(this.target.x+=this.mouseAtEdge.x*t,n=!0),this.mouseAtEdge.y!==0&&(this.target.z+=this.mouseAtEdge.y*t,n=!0)),this.target.x=wt.clamp(this.target.x,5,this.MAP_WIDTH-5),this.target.z=wt.clamp(this.target.z,5,this.MAP_HEIGHT-5),n&&this.updateCameraPosition(this.camera.position.y)}getCamera(){return this.camera}onResize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}panTo(e,t,n=0){this.target.set(e,0,t),this.updateCameraPosition(this.camera.position.y)}setHelpOverlayOpen(e){this.helpOverlayOpen=e}},kl=class{domElement;camera;raycaster;mouse;inputState={mouseDown:!1,mouseButton:-1,mouseStartX:0,mouseStartY:0,mouseCurrentX:0,mouseCurrentY:0,shiftKey:!1,ctrlKey:!1};listeners={};constructor(e,t,n){this.domElement=e,this.camera=t,this.raycaster=new io,this.mouse=new W,this.setupEvents()}setupEvents(){this.domElement.addEventListener(`pointerdown`,this.onPointerDown.bind(this)),this.domElement.addEventListener(`pointermove`,this.onPointerMove.bind(this)),this.domElement.addEventListener(`pointerup`,this.onPointerUp.bind(this)),this.domElement.addEventListener(`contextmenu`,e=>e.preventDefault())}onPointerDown(e){e.preventDefault(),this.inputState.mouseDown=!0,this.inputState.mouseButton=e.button,this.inputState.mouseStartX=e.clientX,this.inputState.mouseStartY=e.clientY,this.inputState.shiftKey=e.shiftKey,this.inputState.ctrlKey=e.ctrlKey,this.updateMouse(e)}onPointerMove(e){this.updateMouse(e),this.inputState.mouseDown&&(this.inputState.mouseCurrentX=e.clientX,this.inputState.mouseCurrentY=e.clientY);let t=this.getWorldPosition(e);this.listeners.onHover&&this.listeners.onHover(t)}onPointerUp(e){if(!this.inputState.mouseDown)return;this.updateMouse(e);let t=Math.abs(e.clientX-this.inputState.mouseStartX),n=Math.abs(e.clientY-this.inputState.mouseStartY);if(this.inputState.mouseButton===0){if(t<5&&n<5){let t=this.getWorldPosition(e);t&&this.listeners.onLeftClick&&this.listeners.onLeftClick(t,this.inputState.shiftKey)}else{let t=this.screenToWorld(this.inputState.mouseStartX,this.inputState.mouseStartY),n=this.getWorldPosition(e);t&&n&&this.listeners.onBoxSelect&&this.listeners.onBoxSelect(t,n,this.inputState.shiftKey)}}else if(this.inputState.mouseButton===2){let t=this.getWorldPosition(e);t&&this.listeners.onRightClick&&this.listeners.onRightClick(t)}this.inputState.mouseDown=!1,this.inputState.mouseButton=-1}updateMouse(e){let t=this.domElement.getBoundingClientRect();this.mouse.x=(e.clientX-t.left)/t.width*2-1,this.mouse.y=-((e.clientY-t.top)/t.height)*2+1}getWorldPosition(e){return this.updateMouse(e),this.raycastToGround()}screenToWorld(e,t){let n=this.domElement.getBoundingClientRect();return this.mouse.x=(e-n.left)/n.width*2-1,this.mouse.y=-((t-n.top)/n.height)*2+1,this.raycastToGround()}raycastToGround(){this.raycaster.setFromCamera(this.mouse,this.camera);let e=new yi(new G(0,1,0),0),t=new G;return this.raycaster.ray.intersectPlane(e,t),t||null}getRaycaster(){return this.raycaster.setFromCamera(this.mouse,this.camera),this.raycaster}on(e,t){switch(e){case`leftclick`:this.listeners.onLeftClick=t;break;case`rightclick`:this.listeners.onRightClick=t;break;case`boxselect`:this.listeners.onBoxSelect=t;break;case`hover`:this.listeners.onHover=t}}update(e){}dispose(){this.domElement.removeEventListener(`pointerdown`,this.onPointerDown.bind(this)),this.domElement.removeEventListener(`pointermove`,this.onPointerMove.bind(this)),this.domElement.removeEventListener(`pointerup`,this.onPointerUp.bind(this))}getBoxSelectBounds(){if(!this.inputState.mouseDown||this.inputState.mouseButton!==0)return null;let e=Math.abs(this.inputState.mouseCurrentX-this.inputState.mouseStartX),t=Math.abs(this.inputState.mouseCurrentY-this.inputState.mouseStartY);return e<5&&t<5?null:{start:new W(this.inputState.mouseStartX,this.inputState.mouseStartY),end:new W(this.inputState.mouseCurrentX,this.inputState.mouseCurrentY)}}},Al=class{mesh;scene;creature;currentHp;team;role;isSelected=!1;targetEnemy=null;targetResourceNode=null;targetConstructionBuilding=null;homeBuilding=null;carryingBiomass=0;gatherState=`idle`;gatherTimer=0;unitId=Math.random().toString(36).substr(2,9);targetPosition=null;attackCooldown=0;ATTACK_COOLDOWN_MS=1e3;selectionRing=null;hpBarContainer;constructor(e,t,n,r,i=`combat`,a=null){this.scene=e,this.creature=n,this.currentHp=n.hp,this.team=r,this.role=i,this.homeBuilding=a,this.mesh=new Sn,this.mesh.position.copy(t),this.createUnitMesh(),this.createSelectionRing(),this.hpBarContainer=new Sn,this.updateHpBar(),this.mesh.add(this.hpBarContainer),e.add(this.mesh)}createUnitMesh(){let e=this.role===`worker`?1.5:2,t=this.team===`player`?3003583:16347926;if(this.role===`worker`){let t=new Ui(.3,.25,1,8),n=new ia({color:16436245,roughness:.7,metalness:.2}),r=new Y(t,n);r.position.set(-.4,.5,0),r.castShadow=!0,this.mesh.add(r);let i=new Y(t,n);i.position.set(.4,.5,0),i.castShadow=!0,this.mesh.add(i);let a=new Y(new Hi(e,e*.8,e*.6),n);a.position.y=1.6,a.castShadow=!0,a.receiveShadow=!0,this.mesh.add(a);let o=new Y(new Ki(.5,16,16),n);o.position.y=2.5,o.castShadow=!0,this.mesh.add(o);let s=new Ui(.1,.1,e*1.2),c=new ia({color:8736014}),l=new Y(s,c);l.rotation.z=Math.PI/4,l.position.set(e*.5,1.5,0),l.castShadow=!0,this.mesh.add(l);let u=new Y(new Hi(.8,.2,.2),c);u.position.set(e*.9,2.2,0),u.castShadow=!0,this.mesh.add(u)}else{let t=parseInt(this.creature.primaryColor.replace(`#`,`0x`)),n=parseInt(this.creature.secondaryColor.replace(`#`,`0x`)),r=new Ui(.4,.35,1.2,8),i=new ia({color:t,roughness:.6,metalness:.2}),a=new Y(r,i);a.position.set(-.5,.6,0),a.castShadow=!0,this.mesh.add(a);let o=new Y(r,i);o.position.set(.5,.6,0),o.castShadow=!0,this.mesh.add(o);let s=new Y(new Ki(e*.7,16,16),i);s.position.y=2,s.scale.y=1.2,s.castShadow=!0,s.receiveShadow=!0,this.mesh.add(s);let c=new Wi(e*.5,e*.8,8),l=new ia({color:n,roughness:.6,metalness:.3}),u=new Y(c,l);u.position.y=3.2,u.castShadow=!0,this.mesh.add(u);let d=new Hi(.3,1.2,.3),f=new Y(d,l);f.position.set(-e*.6,2,e*.3),f.rotation.z=Math.PI/6,f.castShadow=!0,this.mesh.add(f);let p=new Y(d,l);p.position.set(e*.6,2,e*.3),p.rotation.z=-Math.PI/6,p.castShadow=!0,this.mesh.add(p);let m=new Wi(.2,.5,4),h=new Y(m,l);h.position.set(-e*.7,1.2,e*.5),h.rotation.x=Math.PI,h.castShadow=!0,this.mesh.add(h);let g=new Y(m,l);g.position.set(e*.7,1.2,e*.5),g.rotation.x=Math.PI,g.castShadow=!0,this.mesh.add(g)}let n=new Y(new qi(e*.8,.12,8,16),new ia({color:t,emissive:t,emissiveIntensity:.5}));n.rotation.x=Math.PI/2,n.position.y=.1,this.mesh.add(n)}createSelectionRing(){let e=new qi(3,.15,8,32),t=new ti({color:65280,transparent:!0,opacity:0});this.selectionRing=new Y(e,t),this.selectionRing.rotation.x=Math.PI/2,this.selectionRing.position.y=.1,this.mesh.add(this.selectionRing)}updateHpBar(){this.hpBarContainer.clear();let e=this.currentHp/this.creature.hp,t=.3,n=new Y(new Gi(3,t),new ti({color:0,transparent:!0,opacity:.5}));n.position.y=4,this.hpBarContainer.add(n);let r;r=e>.5?65280:e>.25?16776960:16711680;let i=new Y(new Gi(3*e,t),new ti({color:r}));i.position.set(-(3*(1-e))/2,4,.01),this.hpBarContainer.add(i)}setSelected(e){this.isSelected=e,this.selectionRing&&(this.selectionRing.material.opacity=e?.8:0)}takeDamage(e){return this.currentHp=Math.max(0,this.currentHp-e),this.updateHpBar(),this.currentHp<=0&&(this.setSelected(!1),!0)}moveToPosition(e,t){this.targetPosition=new G(e,0,t)}orderGather(e){this.role===`worker`&&this.homeBuilding&&(this.targetConstructionBuilding&&=(this.targetConstructionBuilding.assignedWorkers.delete(this.unitId),null),this.targetResourceNode=e,this.gatherState=`moving_to_resource`,this.targetEnemy=null,this.moveToPosition(e.getPosition().x,e.getPosition().z))}orderConstruct(e){this.role===`worker`&&e.buildingState===`constructing`&&(this.targetResourceNode=null,this.gatherState=`constructing`,this.targetEnemy=null,this.targetConstructionBuilding=e,e.assignedWorkers.add(this.unitId),this.moveToPosition(e.getPosition().x,e.getPosition().z))}attackTarget(e){if(!(this.attackCooldown>0)&&this.getPosition().distanceTo(e.getPosition())<=this.creature.range*3){let t=e.takeDamage(this.creature.attack);this.attackCooldown=this.ATTACK_COOLDOWN_MS,this.creature.range>2&&this.showProjectile(e),t&&(this.targetEnemy=null)}}showProjectile(e){let t=new Y(new Ki(.3),new ti({color:16776960}));t.position.copy(this.getPosition()),t.position.y+=2,this.scene.add(t);let n=t.position.clone(),r=e.getPosition().clone();r.y+=2;let i=0,a=()=>{if(i+=.05,i>=1){this.scene.remove(t);return}t.position.lerpVectors(n,r,i),requestAnimationFrame(a)};a()}update(e){if(this.attackCooldown>0&&(this.attackCooldown=Math.max(0,this.attackCooldown-e)),this.targetPosition){let t=this.getPosition(),n=new G().subVectors(this.targetPosition,t),r=n.length();if(r>.5){let i=this.role===`worker`?this.creature.speed*Q.WORKER_SPEED:this.creature.speed;n.normalize();let a=i*.01*e;t.add(n.multiplyScalar(Math.min(a,r))),this.mesh.position.set(t.x,0,t.z);let o=Math.atan2(n.x,n.z);this.mesh.rotation.y=o}else this.targetPosition=null}this.role===`worker`&&this.gatherState!==`idle`&&this.updateGatherBehavior(e),this.hpBarContainer&&this.hpBarContainer.lookAt(this.scene.userData.cameraPosition||new G(0,50,50))}updateGatherBehavior(e){if(this.gatherState===`constructing`){if(!this.targetConstructionBuilding||this.targetConstructionBuilding.buildingState!==`constructing`){this.targetConstructionBuilding&&this.targetConstructionBuilding.assignedWorkers.delete(this.unitId),this.targetConstructionBuilding=null,this.gatherState=`idle`;return}this.getPosition().distanceTo(this.targetConstructionBuilding.getPosition())>5&&this.moveToPosition(this.targetConstructionBuilding.getPosition().x,this.targetConstructionBuilding.getPosition().z);return}if(!this.targetResourceNode||!this.homeBuilding){this.gatherState=`idle`;return}let t=this.getPosition().distanceTo(this.targetResourceNode.getPosition()),n=this.getPosition().distanceTo(this.homeBuilding.getPosition());switch(this.gatherState){case`moving_to_resource`:t<3&&(this.gatherState=`gathering`,this.gatherTimer=0,this.targetPosition=null);break;case`gathering`:if(this.gatherTimer+=e,this.gatherTimer>=Q.WORKER_GATHER_INTERVAL){if(this.targetResourceNode.isEmpty())this.gatherState=`idle`,this.targetResourceNode=null;else{let e=this.targetResourceNode.gather(Q.WORKER_GATHER_RATE);this.carryingBiomass=e,this.gatherState=`returning`;let t=this.homeBuilding.getPosition();this.moveToPosition(t.x,t.z)}}break;case`returning`:case`moving_to_dropoff`:if(n<5){if(this.carryingBiomass>0&&(this.scene.dispatchEvent({type:`resource-gathered`,team:this.team,amount:this.carryingBiomass}),this.carryingBiomass=0),this.targetResourceNode&&!this.targetResourceNode.isEmpty()){this.gatherState=`moving_to_resource`;let e=this.targetResourceNode.getPosition();this.moveToPosition(e.x,e.z)}else this.gatherState=`idle`,this.targetResourceNode=null}}}findNearestEnemy(e){let t=null,n=1/0;for(let r of e){let e=this.getPosition().distanceTo(r.getPosition());e<n&&(n=e,t=r)}return t}getPosition(){return this.mesh.position.clone()}getMesh(){return this.mesh}setVisible(e){this.mesh.visible=e}destroy(){this.targetConstructionBuilding&&this.targetConstructionBuilding.assignedWorkers.delete(this.unitId),this.scene.remove(this.mesh),this.mesh.traverse(e=>{e instanceof Y&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())})}},jl=class{mesh;scene;currentHp;maxHp;team;buildingType;buildingState=`complete`;constructionProgress=0;constructionTotalTime;assignedWorkers=new Set;hpBarContainer;progressBarContainer;trainQueue=[];maxQueueSize=5;constructor(e,t,n,r=`HQ`,i=`complete`){switch(this.scene=e,this.team=n,this.buildingType=r,this.buildingState=i,r){case`HQ`:this.maxHp=500,this.constructionTotalTime=0;break;case`Camp`:this.maxHp=200,this.constructionTotalTime=25e3;break;case`ProductionCell`:this.maxHp=250,this.constructionTotalTime=35e3;break;case`EnergyMast`:this.maxHp=150,this.constructionTotalTime=2e4}this.currentHp=i===`complete`?this.maxHp:0,this.mesh=new Sn,this.mesh.position.copy(t),this.createBuildingMesh(),this.hpBarContainer=new Sn,this.updateHpBar(),this.mesh.add(this.hpBarContainer),this.progressBarContainer=new Sn,i===`constructing`&&this.updateProgressBar(),this.mesh.add(this.progressBarContainer),e.add(this.mesh)}createBuildingMesh(){let e=this.team===`player`?3003583:16347926,t=this.buildingState===`constructing`?.5:1;if(this.buildingType===`HQ`){let n=new Ui(6,7,15,8),r=new ia({color:e,roughness:.6,metalness:.4,emissive:e,emissiveIntensity:.2,transparent:this.buildingState===`constructing`,opacity:t}),i=new Y(n,r);i.position.y=7.5,i.castShadow=!0,i.receiveShadow=!0,this.mesh.add(i);let a=new Y(new Ui(5,6,8,8),r);a.position.y=19,a.castShadow=!0,this.mesh.add(a);let o=new Y(new Wi(6,6,8),new ia({color:e,roughness:.5,metalness:.6,emissive:e,emissiveIntensity:.3,transparent:this.buildingState===`constructing`,opacity:t}));o.position.y=26,o.castShadow=!0,this.mesh.add(o);let s=new Y(new Ki(1,16,16),new ia({color:16766720,emissive:16766720,emissiveIntensity:.8,metalness:.9,transparent:this.buildingState===`constructing`,opacity:t}));s.position.y=29,this.mesh.add(s);for(let e=0;e<8;e++){let n=e/8*Math.PI*2,r=new Y(new Hi(.8,1.5,.3),new ia({color:16777130,emissive:16777130,emissiveIntensity:.5,transparent:this.buildingState===`constructing`,opacity:t}));r.position.set(Math.cos(n)*6.5,10+e%3*3,Math.sin(n)*6.5),r.lookAt(0,r.position.y,0),this.mesh.add(r)}}else if(this.buildingType===`Camp`){let n=new ia({color:e,roughness:.7,metalness:.3,transparent:this.buildingState===`constructing`,opacity:t}),r=new Y(new Ui(3,3.5,1,8),n);r.position.y=.5,r.castShadow=!0,this.mesh.add(r);let i=new Y(new Wi(3,5,8),n);i.position.y=3.5,i.castShadow=!0,this.mesh.add(i);let a=new Y(new Ui(.1,.1,2,4),n);a.position.y=7,this.mesh.add(a)}else if(this.buildingType===`ProductionCell`){let n=new ia({color:e,roughness:.8,metalness:.5,transparent:this.buildingState===`constructing`,opacity:t}),r=new Y(new Hi(5,6,5),n);r.position.y=3,r.castShadow=!0,this.mesh.add(r);let i=new Y(new Ui(.8,.8,3,8),n);if(i.position.set(1.5,7.5,1.5),this.mesh.add(i),this.buildingState===`complete`){let e=new Y(new Ki(.5,8,8),new ia({color:65535,emissive:65535,emissiveIntensity:.8}));e.position.y=5,this.mesh.add(e)}}else if(this.buildingType===`EnergyMast`){let n=new ia({color:e,roughness:.5,metalness:.7,transparent:this.buildingState===`constructing`,opacity:t}),r=new Y(new Ui(2,2.5,2,6),n);r.position.y=1,r.castShadow=!0,this.mesh.add(r);let i=new Y(new Ui(.8,1.2,8,6),n);if(i.position.y=6,i.castShadow=!0,this.mesh.add(i),this.buildingState===`complete`){let e=new Y(new Ki(1.2,16,16),new ia({color:16776960,emissive:16776960,emissiveIntensity:.9,metalness:.8}));e.position.y=11,this.mesh.add(e)}}let n=new Y(new Ui(this.buildingType===`HQ`?10:4,this.buildingType===`HQ`?12:5,1,16),new ia({color:4473924,roughness:.9,transparent:this.buildingState===`constructing`,opacity:t}));n.position.y=.5,n.receiveShadow=!0,this.mesh.add(n)}updateHpBar(){this.hpBarContainer.clear();let e=this.currentHp/this.maxHp,t=.6,n=new Y(new Gi(12,t),new ti({color:0,transparent:!0,opacity:.7}));n.position.y=32,this.hpBarContainer.add(n);let r;r=e>.5?65280:e>.25?16776960:16711680;let i=new Y(new Gi(12*e,t),new ti({color:r}));i.position.set(-(12*(1-e))/2,32,.01),this.hpBarContainer.add(i)}takeDamage(e){this.currentHp=Math.max(0,this.currentHp-e),this.updateHpBar()}update(){this.hpBarContainer&&this.scene.userData.cameraPosition&&this.hpBarContainer.lookAt(this.scene.userData.cameraPosition),this.progressBarContainer&&this.scene.userData.cameraPosition&&this.progressBarContainer.lookAt(this.scene.userData.cameraPosition)}advanceConstruction(e){if(this.buildingState!==`constructing`)return;let t=this.assignedWorkers.size,n=0;t===1?n=1:t>=2&&(n=2);let r=e/this.constructionTotalTime*n;this.constructionProgress+=r,this.constructionProgress>=1?(this.constructionProgress=1,this.buildingState=`complete`,this.currentHp=this.maxHp,this.mesh.clear(),this.createBuildingMesh(),this.hpBarContainer=new Sn,this.updateHpBar(),this.mesh.add(this.hpBarContainer),this.progressBarContainer.clear()):this.updateProgressBar()}advanceTrainQueue(e){if(this.buildingState!==`complete`||this.trainQueue.length===0)return;let t=this.trainQueue[0];t.elapsedTime+=e,t.elapsedTime>=t.totalTime&&this.trainQueue.shift()}addToTrainQueue(e){return this.trainQueue.length>=this.maxQueueSize?!1:(this.trainQueue.push(e),!0)}cancelTrainQueueItem(e){if(e<0||e>=this.trainQueue.length)return null;let t=this.trainQueue[e];return this.trainQueue.splice(e,1),{dna:Math.floor(t.costDNA*.5),biomass:Math.floor(t.costBiomass*.5)}}updateProgressBar(){if(this.progressBarContainer.clear(),this.buildingState!==`constructing`)return;let e=.5,t=this.buildingType===`HQ`?35:12,n=new Y(new Gi(8,e),new ti({color:3355443,transparent:!0,opacity:.8}));n.position.y=t,this.progressBarContainer.add(n);let r=new Y(new Gi(8*this.constructionProgress,e),new ti({color:65280}));r.position.set(-(8*(1-this.constructionProgress))/2,t,.01),this.progressBarContainer.add(r);let i=this.assignedWorkers.size,a=0;i===1?a=1:i>=2&&(a=2);let o=1-this.constructionProgress,s=a>0?o*this.constructionTotalTime/a:this.constructionTotalTime,c=Math.ceil(s/1e3),l=`${Math.floor(this.constructionProgress*100)}% · ${c}s`,u=document.createElement(`canvas`);u.width=256,u.height=64;let d=u.getContext(`2d`);d.fillStyle=`#ffffff`,d.font=`bold 32px Arial`,d.textAlign=`center`,d.textBaseline=`middle`,d.fillText(l,128,32);let f=new Gr(new jr({map:new Ri(u),transparent:!0}));f.scale.set(4,1,1),f.position.y=t+1,this.progressBarContainer.add(f)}getPosition(){return this.mesh.position.clone()}getMesh(){return this.mesh}destroy(){this.scene.remove(this.mesh),this.mesh.traverse(e=>{e instanceof Y&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())})}get x(){return this.mesh.position.x}get y(){return this.mesh.position.z}},Ml=class{mesh;scene;data;textMesh=null;constructor(e,t){this.scene=e,this.data=t,this.mesh=new Sn,this.mesh.position.set(t.x,0,t.y),this.createNodeMesh(),this.updateLabel(),e.add(this.mesh)}createNodeMesh(){if(this.data.type===`biomass`){let e=new Wi(1.5,5,6),t=new ia({color:65450,emissive:65450,emissiveIntensity:.6,roughness:.2,metalness:.8,transparent:!0,opacity:.9}),n=new Y(e,t);n.position.y=2.5,n.castShadow=!0,this.mesh.add(n),[{x:1.5,y:1.2,z:0,scale:.6,rotZ:.3},{x:-1.2,y:1.5,z:.5,scale:.7,rotZ:-.2},{x:0,y:1,z:1.5,scale:.5,rotZ:.4},{x:-.8,y:1.3,z:-1.2,scale:.6,rotZ:-.3}].forEach(e=>{let n=new Y(new Wi(.8,3,6),t);n.position.set(e.x,e.y,e.z),n.scale.setScalar(e.scale),n.rotation.z=e.rotZ,n.castShadow=!0,this.mesh.add(n)});let r=new Ia(65450,.8,10);r.position.y=3,this.mesh.add(r)}let e=new Y(new Ui(2.5,3,.5,16),new ia({color:43656,emissive:43656,emissiveIntensity:.3,roughness:.7,metalness:.5}));e.position.y=.25,e.receiveShadow=!0,this.mesh.add(e)}updateLabel(){this.textMesh&&this.mesh.remove(this.textMesh);let e=document.createElement(`canvas`);e.width=128,e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#000000`,t.fillRect(0,0,e.width,e.height),t.fillStyle=`#22C55E`,t.font=`bold 24px Arial`,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(this.data.amount.toString(),e.width/2,e.height/2);let n=new ti({map:new Ri(e),transparent:!0,side:2}),r=new Gi(4,2);this.textMesh=new Y(r,n),this.textMesh.position.y=4,this.mesh.add(this.textMesh)}gather(e){if(this.isEmpty())return 0;let t=Math.min(e,this.data.amount);if(this.data.amount-=t,this.updateLabel(),this.mesh.children[0]){let e=this.mesh.children[0].scale.clone();this.mesh.children[0].scale.multiplyScalar(1.2),setTimeout(()=>{this.mesh.children[0]&&this.mesh.children[0].scale.copy(e)},100)}return t}isEmpty(){return this.data.amount<=0}update(){this.textMesh&&this.scene.userData.cameraPosition&&this.textMesh.lookAt(this.scene.userData.cameraPosition)}getPosition(){return this.mesh.position.clone()}get x(){return this.mesh.position.x}get y(){return this.mesh.position.z}destroy(){this.scene.remove(this.mesh),this.mesh.traverse(e=>{e instanceof Y&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())})}},Nl={forge:{title:`המזקקה`,slotEmpty:`בחר יצור`,merge:`מזג`,mergeDisabledHint:`בחר שני יצורים`,reset:`אפס בחירה`,toDeploy:`לזירה`},deploy:{title:`לזירה`,you:`אתה`,rival:`יריב`,start:`התחל קרב`,back:`חזרה למזקקה`},battle:{title:`קרב`,win:`ניצחת!`,lose:`הפסדת`,again:`קרב נוסף`,forge:`חזרה למזקקה`,hintSelect:`בחר יחידה`,hintMove:`לחץ על המפה כדי להזיז`,selected:`נבחר`,noneSelected:`לא נבחרה יחידה`},stat:{hp:`חיים`,atk:`התקפה`,spd:`מהירות`,tag:`יכולת`},minimap:{label:`מפה`,a11y:`מינימפה. לחץ כדי להזיז את המצלמה`},fog:{helpLine:`במפה: כהה=לא נחשף, אפור=נחשף, בהיר=מה שרואים עכשיו.`},help:{title:`קיצורי מקלדת`,openHint:`עזרה`,close:`סגור`,closeHint:`Esc לסגירה`,keyWasd:`WASD / חצים`,actionWasd:`הזזת מצלמה`,keyZoom:`גלגלת`,actionZoom:`תקריב / הרחקה`,keySelect:`לחיצה שמאלית`,actionSelect:`בחירת יחידה`,keyMove:`לחיצה ימנית`,actionMove:`תנועה / פקודה`,keyDeselect:`Esc`,actionDeselect:`ביטול בחירה`,keyMinimap:`לחיצה על המפה`,actionMinimap:`קפיצת מצלמה`},onboard:{forge:`בחר שני יצורים — המזקקה תיצור מהם היבריד לקרב.`,afterMerge:`ההיבריד מוכן. לחץ לזירה כדי לפרוס אותו.`,deploy:`אתה משמאל (טורקיז), היריב מימין. לחץ התחל קרב.`,battle:`אסוף ביומסה בפועלים, אמן יחידות מהבסיס, השמד את בסיס היריב.`,cameraFog:`הזז את המצלמה ב־WASD. השטח הכהה במפה עדיין מוסתר בערפל.`,dismiss:`הבנתי`},controls:{title:`בקרות המשחק`,camera:`מצלמה`,cameraWASD:`WASD / חצים - הזז מצלמה`,cameraWheel:`גלגלת עכבר - זום`,cameraEdge:`עכבר בקצה מסך - הזז מצלמה`,cameraMinimap:`קליק על מפה קטנה - קפיצה למיקום`,selection:`בחירה`,selectionClick:`קליק שמאלי - בחר יחידה`,selectionBox:`גרירה - בחירה מרובה`,selectionShift:`Shift+קליק - הוסף/הסר`,selectionCtrlA:`Ctrl+A - בחר הכל`,selectionSpace:`רווח - מרכז על בחירה`,commands:`פקודות`,commandsMove:`קליק ימני - הזז/תקוף`,commandsStop:`X / Delete - עצור`,controlGroups:`קבוצות בקרה`,controlGroupsAssign:`Ctrl+1-0 - הקצה קבוצה`,controlGroupsRecall:`1-0 - קרא קבוצה`,other:`אחר`,otherEsc:`Esc - בטל בחירה`,otherHelp:`F1 / ? - עזרה`,close:`סגור`},hud:{dna:`DNA`,biomass:`ביומסה`,baseHp:`בסיס`},panel:{train:`אמן`,worker:`פועל`,needRes:`אין מספיק משאבים`},zoo:{title:`הכלוב`,slotEmpty:`ריק`,cta:`לזירה`,search:`חיפוש`,filter:`סינון`},build:{camp:`מחנה`,cell:`תא ייצור`,mast:`מוט אנרגיה`,place:`לחץ לאישור · ימני לביטול`,progress:`בנייה…`,building:`בונה`},queue:{cancel:`ביטול`,full:`התור מלא`,progress:`בהתקדמות`},win:{destroyBase:`הבסיס נהרס — ניצחת!`,title:`ניצחון!`},lose:{baseDown:`הבסיס שלך נהרס`,title:`הפסד`},gameOver:{anotherBattle:`קרב נוסף`,backToCage:`חזרה לכלוב`},economy:{biomass:`ביומסה`,biomassEn:`Biomass`,dna:`DNA`,dnaEn:`DNA`,resources:`משאבים`,trainWorker:`אמן עובד`,trainUnit:`אמן לוחם`,worker:`עובד`,gathering:`אוסף`,returning:`חוזר`,hq:`מטה ראשי`,hqDestroyed:`המטה הושמד!`,notEnoughResources:`אין מספיק משאבים`,workerInfo:`עובד - אוסף ביומסה`,unitInfo:`לוחם - יחידת קרב`}},$={player:3003583,playerHex:`#2DD4BF`,rival:16347926,rivalHex:`#F97316`},Pl=JSON.parse(`[{"id":"echo-bat","nameHe":"עטלף-הד","nameEn":"Echo Bat","tags":["scout"],"hp":50,"speed":9,"attack":10,"range":1,"special":"חשיפת ערפל באזור","specialEn":"Fog reveal in area","dnaCost":40,"biomassCost":20,"researchTier":1,"size":2},{"id":"basalt-rhino","nameHe":"קרנף-בזלת","nameEn":"Basalt Rhino","tags":["tank"],"hp":180,"speed":3,"attack":18,"range":1,"special":"מגן ודחיפה קדימה","specialEn":"Shield shove forward","dnaCost":100,"biomassCost":60,"researchTier":2,"size":8},{"id":"quill-serpent","nameHe":"נחש-זיפים","nameEn":"Quill Serpent","tags":["assassin"],"hp":55,"speed":8,"attack":28,"range":1,"special":"רעל נזק לאורך זמן","specialEn":"Poison damage over time","dnaCost":70,"biomassCost":25,"researchTier":1,"size":3},{"id":"vinegar-eagle","nameHe":"עיט-חומץ","nameEn":"Vinegar Eagle","tags":["ranged","flyer"],"hp":70,"speed":8,"attack":16,"range":4,"special":"צלילה מהירה פגיעה","specialEn":"Dive strike burst","dnaCost":80,"biomassCost":40,"researchTier":2,"size":4},{"id":"crystal-crab","nameHe":"סרטן-גביש","nameEn":"Crystal Crab","tags":["tank"],"hp":160,"speed":2,"attack":12,"range":1,"special":"שריון מחזיר נזק","specialEn":"Armor reflect damage","dnaCost":85,"biomassCost":50,"researchTier":2,"size":5},{"id":"ink-octopus","nameHe":"תמנון-דיו","nameEn":"Ink Octopus","tags":["control","aquatic"],"hp":90,"speed":4,"attack":11,"range":3,"special":"דיו מאט אויבים","specialEn":"Ink slows enemies","dnaCost":65,"biomassCost":35,"researchTier":2,"size":4},{"id":"horn-stag","nameHe":"צבי-קרן","nameEn":"Horn Stag","tags":["skirmish"],"hp":85,"speed":7,"attack":20,"range":2,"special":"נגיחה ודחיפה","specialEn":"Ram shove knockback","dnaCost":55,"biomassCost":30,"researchTier":1,"size":5},{"id":"thunder-frog","nameHe":"צפרדע-רעם","nameEn":"Thunder Frog","tags":["artillery"],"hp":60,"speed":3,"attack":32,"range":5,"special":"קפיצת הלם שטחית","specialEn":"Shock hop area blast","dnaCost":90,"biomassCost":45,"researchTier":2,"size":3},{"id":"ember-moth","nameHe":"עש-גחלת","nameEn":"Ember Moth","tags":["swarm","flyer"],"hp":47,"speed":8,"attack":9,"range":1,"special":"להבות קטנות בעדר","specialEn":"Tiny flames in swarm","dnaCost":48,"biomassCost":20,"researchTier":1,"size":1},{"id":"glass-mole","nameHe":"חפרפרת-זכוכית","nameEn":"Glass Mole","tags":["burrower","scout"],"hp":54,"speed":6,"attack":11,"range":1,"special":"חפירה שקופה מהירה","specialEn":"Fast translucent burrow","dnaCost":51,"biomassCost":20,"researchTier":1,"size":1},{"id":"moss-boar","nameHe":"חזיר-טחב","nameEn":"Moss Boar","tags":["tank","skirmish"],"hp":142,"speed":4,"attack":20,"range":1,"special":"מגן טחב מתחדש","specialEn":"Regen moss shield","dnaCost":93,"biomassCost":32,"researchTier":4,"size":7},{"id":"silk-spider","nameHe":"עכביש-משי","nameEn":"Silk Spider","tags":["control","assassin"],"hp":72,"speed":7,"attack":16,"range":2,"special":"רשת מאטה יעד","specialEn":"Web slows target","dnaCost":67,"biomassCost":40,"researchTier":3,"size":4},{"id":"salt-ray","nameHe":"טריגון-מלח","nameEn":"Salt Ray","tags":["aquatic","ranged"],"hp":82,"speed":5,"attack":16,"range":3,"special":"זרם מלח שורף","specialEn":"Salt spray burn","dnaCost":69,"biomassCost":38,"researchTier":3,"size":4},{"id":"cinder-hare","nameHe":"ארנב-אפר","nameEn":"Cinder Hare","tags":["scout","skirmish"],"hp":54,"speed":10,"attack":12,"range":1,"special":"שביל אפר מסתיר","specialEn":"Ash trail cloaks","dnaCost":55,"biomassCost":22,"researchTier":2,"size":2},{"id":"iron-toad","nameHe":"קרפדה-ברזל","nameEn":"Iron Toad","tags":["tank","artillery"],"hp":159,"speed":2,"attack":26,"range":3,"special":"יריקת מתכת כבדה","specialEn":"Heavy metal spit","dnaCost":107,"biomassCost":56,"researchTier":5,"size":9},{"id":"whisper-owl","nameHe":"ינשוף-לחישה","nameEn":"Whisper Owl","tags":["scout","flyer"],"hp":61,"speed":8,"attack":14,"range":2,"special":"שתיקה מסתירה יחידה","specialEn":"Silence cloaks unit","dnaCost":61,"biomassCost":30,"researchTier":3,"size":3},{"id":"razor-urchin","nameHe":"קיפוד-ים-להב","nameEn":"Razor Urchin","tags":["aquatic","swarm"],"hp":69,"speed":3,"attack":15,"range":1,"special":"קוצים פוגעים במגע","specialEn":"Spikes hurt on touch","dnaCost":60,"biomassCost":22,"researchTier":3,"size":2},{"id":"spore-badger","nameHe":"גירית-נבגים","nameEn":"Spore Badger","tags":["support","burrower"],"hp":81,"speed":5,"attack":15,"range":1,"special":"נבגים מרפאים בעלות","specialEn":"Spores heal allies","dnaCost":65,"biomassCost":24,"researchTier":3,"size":3},{"id":"frost-lynx","nameHe":"שונר-כפור","nameEn":"Frost Lynx","tags":["assassin","skirmish"],"hp":90,"speed":9,"attack":25,"range":1,"special":"נשיכת כפור מאטה","specialEn":"Frost bite slows","dnaCost":88,"biomassCost":32,"researchTier":4,"size":7},{"id":"magma-turtle","nameHe":"צב-מגמה","nameEn":"Magma Turtle","tags":["tank"],"hp":182,"speed":2,"attack":20,"range":1,"special":"שריון לוהט שורף","specialEn":"Hot shell burns foes","dnaCost":103,"biomassCost":34,"researchTier":5,"size":8},{"id":"gale-finch","nameHe":"פרוש-סופה","nameEn":"Gale Finch","tags":["flyer","scout"],"hp":43,"speed":10,"attack":9,"range":1,"special":"רוח דוחפת קלות","specialEn":"Gust light knockback","dnaCost":47,"biomassCost":20,"researchTier":1,"size":1},{"id":"thorn-camel","nameHe":"גמל-קוצים","nameEn":"Thorn Camel","tags":["skirmish","support"],"hp":104,"speed":5,"attack":18,"range":2,"special":"קוצים מגנים על בעלות","specialEn":"Thorns shield allies","dnaCost":78,"biomassCost":34,"researchTier":3,"size":5},{"id":"void-leech","nameHe":"עלוקה-ריק","nameEn":"Void Leech","tags":["assassin","aquatic"],"hp":65,"speed":6,"attack":20,"range":1,"special":"גניבת חיים מיעד","specialEn":"Steal life from target","dnaCost":70,"biomassCost":26,"researchTier":3,"size":4},{"id":"pulse-jellyfish","nameHe":"מדוזה-פעימה","nameEn":"Pulse Jellyfish","tags":["control","aquatic"],"hp":69,"speed":3,"attack":11,"range":3,"special":"הלם משבית זמנית","specialEn":"Pulse stun briefly","dnaCost":56,"biomassCost":42,"researchTier":3,"size":2},{"id":"shard-goat","nameHe":"עז-רסיס","nameEn":"Shard Goat","tags":["skirmish"],"hp":98,"speed":7,"attack":20,"range":1,"special":"ניפוץ שריון קל","specialEn":"Armor shatter light","dnaCost":79,"biomassCost":28,"researchTier":3,"size":5},{"id":"dusk-vulture","nameHe":"נשר-דמדומים","nameEn":"Dusk Vulture","tags":["flyer","ranged"],"hp":77,"speed":7,"attack":16,"range":3,"special":"צלילת דמדומים","specialEn":"Dusk dive strike","dnaCost":68,"biomassCost":38,"researchTier":3,"size":4},{"id":"root-boar","nameHe":"חזיר-שורשים","nameEn":"Root Boar","tags":["burrower","tank"],"hp":139,"speed":4,"attack":21,"range":1,"special":"שורשים עוצרים אויב","specialEn":"Roots snare enemy","dnaCost":93,"biomassCost":32,"researchTier":4,"size":7},{"id":"spark-newt","nameHe":"טריטון-ניצוץ","nameEn":"Spark Newt","tags":["artillery","support"],"hp":83,"speed":4,"attack":27,"range":4,"special":"קשת ניצוצות שטחית","specialEn":"Spark arc area hit","dnaCost":88,"biomassCost":58,"researchTier":4,"size":7},{"id":"mirror-gecko","nameHe":"שממית-מראה","nameEn":"Mirror Gecko","tags":["scout","control"],"hp":54,"speed":8,"attack":11,"range":2,"special":"השתקפות מבלבלת","specialEn":"Reflection confuses","dnaCost":54,"biomassCost":36,"researchTier":2,"size":2},{"id":"boulder-ox","nameHe":"שור-סלע","nameEn":"Boulder Ox","tags":["tank"],"hp":176,"speed":3,"attack":24,"range":1,"special":"טריסה כבדה דוחפת","specialEn":"Heavy charge shove","dnaCost":108,"biomassCost":36,"researchTier":5,"size":9},{"id":"venom-wasp","nameHe":"צרעה-ארס","nameEn":"Venom Wasp","tags":["assassin","flyer","swarm"],"hp":64,"speed":9,"attack":22,"range":1,"special":"עקיצת ארס חזקה","specialEn":"Strong venom sting","dnaCost":74,"biomassCost":28,"researchTier":3,"size":5},{"id":"tide-otter","nameHe":"לוטרה-גאות","nameEn":"Tide Otter","tags":["aquatic","skirmish"],"hp":75,"speed":7,"attack":15,"range":1,"special":"גל קצר דוחף","specialEn":"Short wave knockback","dnaCost":64,"biomassCost":24,"researchTier":3,"size":3},{"id":"bloom-deer","nameHe":"אייל-פריחה","nameEn":"Bloom Deer","tags":["support","skirmish"],"hp":80,"speed":7,"attack":13,"range":2,"special":"פריחה מרפאת קלה","specialEn":"Bloom light heal","dnaCost":63,"biomassCost":30,"researchTier":3,"size":3},{"id":"obsidian-scarab","nameHe":"חיפושית-אבסידיאן","nameEn":"Obsidian Scarab","tags":["burrower","tank"],"hp":123,"speed":3,"attack":19,"range":1,"special":"שריון שחור קשה","specialEn":"Hard black armor","dnaCost":85,"biomassCost":30,"researchTier":4,"size":6},{"id":"howl-jackal","nameHe":"תן-יללה","nameEn":"Howl Jackal","tags":["scout","skirmish"],"hp":73,"speed":8,"attack":18,"range":1,"special":"יללה חושפת יחידות","specialEn":"Howl reveals units","dnaCost":69,"biomassCost":26,"researchTier":3,"size":4},{"id":"arc-manta","nameHe":"מנטה-קשת","nameEn":"Arc Manta","tags":["aquatic","artillery"],"hp":113,"speed":5,"attack":30,"range":4,"special":"קשת חשמלית רחוקה","specialEn":"Distant electric arc","dnaCost":102,"biomassCost":62,"researchTier":5,"size":9},{"id":"petal-mantis","nameHe":"גמל-שלמה-עלה","nameEn":"Petal Mantis","tags":["assassin"],"hp":90,"speed":8,"attack":30,"range":1,"special":"מכת עלה קטלנית","specialEn":"Lethal petal slash","dnaCost":95,"biomassCost":34,"researchTier":5,"size":8},{"id":"steam-bison","nameHe":"ביזון-קיטור","nameEn":"Steam Bison","tags":["tank","control"],"hp":157,"speed":4,"attack":22,"range":2,"special":"ענן קיטור מסתיר","specialEn":"Steam cloud blinds","dnaCost":100,"biomassCost":48,"researchTier":5,"size":8},{"id":"needle-porcupine","nameHe":"דורבן-מחט","nameEn":"Needle Porcupine","tags":["ranged","tank"],"hp":112,"speed":3,"attack":16,"range":3,"special":"ירי מחטים צפוף","specialEn":"Dense needle volley","dnaCost":78,"biomassCost":40,"researchTier":3,"size":5},{"id":"drift-albatross","nameHe":"אלבטרוס-סחף","nameEn":"Drift Albatross","tags":["flyer","scout"],"hp":70,"speed":7,"attack":13,"range":2,"special":"ראייה רחבה מעל","specialEn":"Wide aerial vision","dnaCost":61,"biomassCost":30,"researchTier":3,"size":3},{"id":"coral-eel","nameHe":"צלופח-אלמוג","nameEn":"Coral Eel","tags":["aquatic","assassin"],"hp":86,"speed":7,"attack":26,"range":1,"special":"נשיכה חודרת שריון","specialEn":"Armor-piercing bite","dnaCost":88,"biomassCost":32,"researchTier":4,"size":7},{"id":"sand-scorpion","nameHe":"עקרב-חול","nameEn":"Sand Scorpion","tags":["burrower","assassin"],"hp":93,"speed":5,"attack":27,"range":1,"special":"ארס חול משתק","specialEn":"Sand venom paralyze","dnaCost":90,"biomassCost":32,"researchTier":4,"size":7},{"id":"lantern-fish","nameHe":"דג-פנס","nameEn":"Lantern Fish","tags":["aquatic","support"],"hp":54,"speed":5,"attack":9,"range":2,"special":"אור חושף אויבים","specialEn":"Light reveals foes","dnaCost":49,"biomassCost":26,"researchTier":1,"size":1},{"id":"rubble-pangolin","nameHe":"פנגולין-הריסות","nameEn":"Rubble Pangolin","tags":["tank","burrower"],"hp":146,"speed":3,"attack":18,"range":1,"special":"גלגול שריון דורס","specialEn":"Armor roll crush","dnaCost":91,"biomassCost":32,"researchTier":4,"size":7},{"id":"chirp-locust","nameHe":"ארבה-צפצוף","nameEn":"Chirp Locust","tags":["swarm","skirmish"],"hp":43,"speed":8,"attack":10,"range":1,"special":"נחיל מציק לאויב","specialEn":"Swarm harasses foe","dnaCost":48,"biomassCost":20,"researchTier":1,"size":1},{"id":"amber-bear","nameHe":"דב-ענבר","nameEn":"Amber Bear","tags":["tank","skirmish"],"hp":169,"speed":4,"attack":26,"range":1,"special":"חיבוק ענבר מלכד","specialEn":"Amber hug traps","dnaCost":109,"biomassCost":36,"researchTier":5,"size":9},{"id":"gust-falcon","nameHe":"בז-משב","nameEn":"Gust Falcon","tags":["flyer","assassin"],"hp":91,"speed":10,"attack":25,"range":1,"special":"צלילת משב מהירה","specialEn":"Swift gust dive","dnaCost":91,"biomassCost":34,"researchTier":4,"size":8},{"id":"mire-hippo","nameHe":"היפו-ביצה","nameEn":"Mire Hippo","tags":["tank","aquatic"],"hp":183,"speed":3,"attack":24,"range":1,"special":"בוץ עוצר תנועה","specialEn":"Mud stops movement","dnaCost":110,"biomassCost":36,"researchTier":5,"size":9},{"id":"crystal-ibis","nameHe":"איביס-גביש","nameEn":"Crystal Ibis","tags":["ranged","flyer"],"hp":75,"speed":7,"attack":18,"range":4,"special":"קרן גביש דקה","specialEn":"Thin crystal beam","dnaCost":73,"biomassCost":46,"researchTier":4,"size":5},{"id":"smoke-rat","nameHe":"חולדה-עשן","nameEn":"Smoke Rat","tags":["scout","swarm"],"hp":45,"speed":9,"attack":9,"range":1,"special":"עשן מסתיר נתיב","specialEn":"Smoke cloaks path","dnaCost":47,"biomassCost":20,"researchTier":1,"size":1},{"id":"quill-ram","nameHe":"אייל-זיפים","nameEn":"Quill Ram","tags":["skirmish"],"hp":106,"speed":6,"attack":22,"range":1,"special":"נגיחת זיפים דוקרת","specialEn":"Quill ram puncture","dnaCost":85,"biomassCost":30,"researchTier":4,"size":6},{"id":"frost-seal","nameHe":"כלב-ים-כפור","nameEn":"Frost Seal","tags":["aquatic","control"],"hp":100,"speed":4,"attack":15,"range":2,"special":"קרח מחליק רצפה","specialEn":"Ice slicks ground","dnaCost":72,"biomassCost":40,"researchTier":3,"size":4},{"id":"blight-crow","nameHe":"עורב-כיליון","nameEn":"Blight Crow","tags":["flyer","control"],"hp":55,"speed":8,"attack":12,"range":2,"special":"קללת חולשה קלה","specialEn":"Mild blight curse","dnaCost":55,"biomassCost":36,"researchTier":3,"size":2},{"id":"stone-crane","nameHe":"עגור-אבן","nameEn":"Stone Crane","tags":["ranged","support"],"hp":82,"speed":5,"attack":16,"range":4,"special":"זריקת אבן מדויקת","specialEn":"Precise stone throw","dnaCost":69,"biomassCost":44,"researchTier":3,"size":4},{"id":"lava-salamander","nameHe":"סלמנדרה-לבה","nameEn":"Lava Salamander","tags":["artillery","burrower"],"hp":110,"speed":4,"attack":31,"range":4,"special":"יריקת לבה שורפת","specialEn":"Lava spit burn zone","dnaCost":103,"biomassCost":62,"researchTier":5,"size":9},{"id":"pearl-clam","nameHe":"צדפה-פנינה","nameEn":"Pearl Clam","tags":["tank","aquatic"],"hp":158,"speed":2,"attack":14,"range":1,"special":"סגירה מחזקת שריון","specialEn":"Close boosts armor","dnaCost":87,"biomassCost":30,"researchTier":4,"size":6},{"id":"shadow-ferret","nameHe":"חורפן-צל","nameEn":"Shadow Ferret","tags":["assassin","scout"],"hp":73,"speed":9,"attack":24,"range":1,"special":"התגנבות בצללים","specialEn":"Stealth in shadows","dnaCost":81,"biomassCost":30,"researchTier":4,"size":6},{"id":"vine-ape","nameHe":"קוף-גפן","nameEn":"Vine Ape","tags":["skirmish","control"],"hp":96,"speed":6,"attack":18,"range":2,"special":"גפנים מושכות יעד","specialEn":"Vines pull target","dnaCost":76,"biomassCost":42,"researchTier":3,"size":5},{"id":"bolt-hare","nameHe":"ארנבת-ברק","nameEn":"Bolt Hare","tags":["scout","skirmish"],"hp":52,"speed":10,"attack":12,"range":1,"special":"זיגזג מהיר מתחמק","specialEn":"Zigzag dodge dash","dnaCost":54,"biomassCost":22,"researchTier":2,"size":2},{"id":"iron-beetle","nameHe":"חיפושית-ברזל","nameEn":"Iron Beetle","tags":["tank","swarm"],"hp":122,"speed":3,"attack":17,"range":1,"special":"שריון קבוצתי קשיח","specialEn":"Group hard armor","dnaCost":80,"biomassCost":28,"researchTier":3,"size":5},{"id":"mist-heron","nameHe":"אנפה-ערפל","nameEn":"Mist Heron","tags":["flyer","control"],"hp":68,"speed":6,"attack":14,"range":3,"special":"ערפל מאט ירי","specialEn":"Mist slows shots","dnaCost":62,"biomassCost":44,"researchTier":3,"size":3},{"id":"spike-urchin-boar","nameHe":"חזיר-קיפוד","nameEn":"Spike Urchin Boar","tags":["tank","skirmish"],"hp":135,"speed":4,"attack":21,"range":1,"special":"קוצים פוגעים בקרב","specialEn":"Spikes hurt in melee","dnaCost":92,"biomassCost":32,"researchTier":4,"size":7},{"id":"echo-dolphin","nameHe":"דולפין-הד","nameEn":"Echo Dolphin","tags":["aquatic","scout"],"hp":74,"speed":8,"attack":13,"range":2,"special":"סונאר חושף מים","specialEn":"Sonar reveals water","dnaCost":62,"biomassCost":30,"researchTier":3,"size":3},{"id":"ember-fox","nameHe":"שועל-גחלת","nameEn":"Ember Fox","tags":["assassin","skirmish"],"hp":80,"speed":8,"attack":24,"range":1,"special":"זנב אש שורף","specialEn":"Fire tail burn","dnaCost":82,"biomassCost":30,"researchTier":4,"size":6},{"id":"glacier-walrus","nameHe":"ניבתן-קרחון","nameEn":"Glacier Walrus","tags":["tank","aquatic"],"hp":180,"speed":2,"attack":24,"range":1,"special":"מכת ניב קופאת","specialEn":"Tusk strike freezes","dnaCost":109,"biomassCost":36,"researchTier":5,"size":9},{"id":"pollen-bee","nameHe":"דבורה-אבקה","nameEn":"Pollen Bee","tags":["support","flyer","swarm"],"hp":43,"speed":8,"attack":9,"range":1,"special":"אבקה מחזקת בעלות","specialEn":"Pollen buffs allies","dnaCost":47,"biomassCost":20,"researchTier":1,"size":1},{"id":"rift-serpent","nameHe":"נחש-בקע","nameEn":"Rift Serpent","tags":["burrower","assassin"],"hp":94,"speed":7,"attack":28,"range":1,"special":"פריצה מתחת לקרקע","specialEn":"Burst from underground","dnaCost":94,"biomassCost":34,"researchTier":5,"size":8},{"id":"chrome-stork","nameHe":"חסידה-כרום","nameEn":"Chrome Stork","tags":["ranged","flyer"],"hp":85,"speed":6,"attack":18,"range":4,"special":"מקור כרום חודר","specialEn":"Chrome beak pierce","dnaCost":74,"biomassCost":46,"researchTier":4,"size":5},{"id":"bog-crocodile","nameHe":"תנין-ביצה","nameEn":"Bog Crocodile","tags":["tank","aquatic"],"hp":166,"speed":4,"attack":25,"range":1,"special":"גרירה למים עמוקים","specialEn":"Drag into deep water","dnaCost":107,"biomassCost":36,"researchTier":5,"size":9},{"id":"star-moth","nameHe":"עש-כוכב","nameEn":"Star Moth","tags":["support","flyer"],"hp":47,"speed":7,"attack":9,"range":2,"special":"אור כוכב מרפא","specialEn":"Starlight minor heal","dnaCost":48,"biomassCost":26,"researchTier":1,"size":1},{"id":"dust-coyote","nameHe":"קויוט-אבק","nameEn":"Dust Coyote","tags":["scout","skirmish"],"hp":72,"speed":9,"attack":17,"range":1,"special":"ענן אבק מסתיר","specialEn":"Dust cloud cloak","dnaCost":68,"biomassCost":26,"researchTier":3,"size":4},{"id":"volt-crab","nameHe":"סרטן-מתח","nameEn":"Volt Crab","tags":["artillery","aquatic"],"hp":115,"speed":3,"attack":28,"range":4,"special":"פריקת מתח שטחית","specialEn":"Volt discharge AoE","dnaCost":98,"biomassCost":60,"researchTier":5,"size":8},{"id":"bone-vulture","nameHe":"נשר-עצמות","nameEn":"Bone Vulture","tags":["flyer","assassin"],"hp":86,"speed":7,"attack":23,"range":1,"special":"נשיכת עצם מחלישה","specialEn":"Bone bite weakens","dnaCost":82,"biomassCost":30,"researchTier":4,"size":6},{"id":"reed-snake","nameHe":"נחש-קנה","nameEn":"Reed Snake","tags":["assassin","aquatic"],"hp":76,"speed":8,"attack":25,"range":1,"special":"התגנבות בין קנים","specialEn":"Ambush among reeds","dnaCost":82,"biomassCost":30,"researchTier":4,"size":6},{"id":"granite-sheep","nameHe":"כבש-גרניט","nameEn":"Granite Sheep","tags":["tank","skirmish"],"hp":147,"speed":4,"attack":23,"range":1,"special":"נגיחת סלע כבדה","specialEn":"Heavy rock headbutt","dnaCost":99,"biomassCost":34,"researchTier":5,"size":8},{"id":"prism-butterfly","nameHe":"פרפר-פריזמה","nameEn":"Prism Butterfly","tags":["control","flyer"],"hp":50,"speed":7,"attack":10,"range":3,"special":"אור מבלבל אויבים","specialEn":"Light confuses foes","dnaCost":52,"biomassCost":42,"researchTier":2,"size":2},{"id":"tunnel-vole","nameHe":"נברן-מנהרה","nameEn":"Tunnel Vole","tags":["burrower","swarm"],"hp":47,"speed":6,"attack":11,"range":1,"special":"מנהרות לנחיל","specialEn":"Tunnels for swarm","dnaCost":49,"biomassCost":20,"researchTier":1,"size":1},{"id":"tide-heron","nameHe":"אנפה-גאות","nameEn":"Tide Heron","tags":["ranged","aquatic"],"hp":82,"speed":5,"attack":19,"range":4,"special":"מקור מים מדויק","specialEn":"Precise water peck","dnaCost":75,"biomassCost":46,"researchTier":3,"size":5},{"id":"ash-wraith-hound","nameHe":"זאב-אפר-כלאי","nameEn":"Ash Wraith Hound","tags":["skirmish","assassin"],"hp":92,"speed":8,"attack":22,"range":1,"special":"נשיכת אפר שורפת","specialEn":"Ash bite burn","dnaCost":82,"biomassCost":30,"researchTier":4,"size":6},{"id":"copper-iguana","nameHe":"איגואנה-נחושת","nameEn":"Copper Iguana","tags":["tank","ranged"],"hp":115,"speed":3,"attack":16,"range":3,"special":"יריקת נחושת חמה","specialEn":"Hot copper spit","dnaCost":78,"biomassCost":40,"researchTier":3,"size":5},{"id":"gale-ray","nameHe":"טריגון-רוח","nameEn":"Gale Ray","tags":["flyer","aquatic"],"hp":86,"speed":6,"attack":16,"range":2,"special":"משב דוחף אויבים","specialEn":"Gale shove foes","dnaCost":70,"biomassCost":32,"researchTier":3,"size":4},{"id":"spore-toad","nameHe":"קרפדה-נבג","nameEn":"Spore Toad","tags":["control","support"],"hp":84,"speed":3,"attack":12,"range":3,"special":"נבגים מאטים ומחלישים","specialEn":"Spores slow weaken","dnaCost":63,"biomassCost":44,"researchTier":3,"size":3},{"id":"flint-boar","nameHe":"חזיר-צור","nameEn":"Flint Boar","tags":["skirmish","tank"],"hp":136,"speed":5,"attack":23,"range":1,"special":"ניצוצות צור בקרב","specialEn":"Flint sparks melee","dnaCost":97,"biomassCost":34,"researchTier":4,"size":8},{"id":"night-gecko","nameHe":"שממית-לילה","nameEn":"Night Gecko","tags":["scout","assassin"],"hp":60,"speed":8,"attack":17,"range":1,"special":"ראיית לילה חושפת","specialEn":"Night vision reveal","dnaCost":63,"biomassCost":24,"researchTier":3,"size":3},{"id":"magma-crab","nameHe":"סרטן-מגמה","nameEn":"Magma Crab","tags":["tank","artillery"],"hp":159,"speed":2,"attack":27,"range":3,"special":"ירי מגמה כבד","specialEn":"Heavy magma lob","dnaCost":108,"biomassCost":56,"researchTier":5,"size":9},{"id":"silk-moth","nameHe":"עש-משי","nameEn":"Silk Moth","tags":["control","swarm"],"hp":46,"speed":6,"attack":9,"range":2,"special":"חוטי משי מלכדים","specialEn":"Silk threads snare","dnaCost":47,"biomassCost":34,"researchTier":1,"size":1},{"id":"brine-sharkling","nameHe":"כרישון-תמלחת","nameEn":"Brine Sharkling","tags":["aquatic","skirmish"],"hp":112,"speed":7,"attack":25,"range":1,"special":"נשיכת תמלחת שורפת","specialEn":"Brine bite burn","dnaCost":95,"biomassCost":34,"researchTier":4,"size":8},{"id":"root-owl","nameHe":"ינשוף-שורש","nameEn":"Root Owl","tags":["flyer","burrower"],"hp":66,"speed":6,"attack":15,"range":2,"special":"שורשי אוויר תופסים","specialEn":"Air roots snare","dnaCost":62,"biomassCost":30,"researchTier":3,"size":3},{"id":"cinder-stag","nameHe":"צבי-גחלת","nameEn":"Cinder Stag","tags":["skirmish"],"hp":104,"speed":7,"attack":21,"range":2,"special":"קרניים לוהטות דוחפות","specialEn":"Ember antlers shove","dnaCost":84,"biomassCost":36,"researchTier":4,"size":6},{"id":"frost-mite","nameHe":"קרדית-כפור","nameEn":"Frost Mite","tags":["swarm","control"],"hp":43,"speed":5,"attack":9,"range":1,"special":"עקיצת כפור מאטה","specialEn":"Frost bite slows","dnaCost":47,"biomassCost":28,"researchTier":1,"size":1},{"id":"thunder-ox","nameHe":"שור-רעם","nameEn":"Thunder Ox","tags":["tank","artillery"],"hp":178,"speed":3,"attack":29,"range":3,"special":"געיית רעם שטחית","specialEn":"Thunder bellow AoE","dnaCost":116,"biomassCost":58,"researchTier":5,"size":10},{"id":"pearl-otter","nameHe":"לוטרת-פנינה","nameEn":"Pearl Otter","tags":["aquatic","support"],"hp":68,"speed":7,"attack":12,"range":1,"special":"פנינה מחזקת שריון","specialEn":"Pearl armor buff","dnaCost":57,"biomassCost":22,"researchTier":3,"size":2},{"id":"void-bat","nameHe":"עטלף-ריק","nameEn":"Void Bat","tags":["flyer","assassin"],"hp":63,"speed":9,"attack":20,"range":1,"special":"נשיכת ריק מחלישה","specialEn":"Void bite drains","dnaCost":69,"biomassCost":26,"researchTier":3,"size":4},{"id":"sand-falcon","nameHe":"בז-חול","nameEn":"Sand Falcon","tags":["flyer","scout"],"hp":68,"speed":9,"attack":16,"range":2,"special":"סופת חול קלה","specialEn":"Light sandstorm","dnaCost":67,"biomassCost":32,"researchTier":3,"size":4},{"id":"iron-carp","nameHe":"קרפיון-ברזל","nameEn":"Iron Carp","tags":["aquatic","tank"],"hp":130,"speed":4,"attack":17,"range":1,"special":"קשקשים מחזירים מכות","specialEn":"Scales deflect hits","dnaCost":85,"biomassCost":30,"researchTier":4,"size":6},{"id":"bloom-spider","nameHe":"עכביש-פריחה","nameEn":"Bloom Spider","tags":["control","support"],"hp":62,"speed":5,"attack":13,"range":2,"special":"רשת פריחה מרפאת","specialEn":"Bloom web heals","dnaCost":57,"biomassCost":36,"researchTier":3,"size":2},{"id":"shard-eagle","nameHe":"עיט-רסיס","nameEn":"Shard Eagle","tags":["flyer","ranged"],"hp":93,"speed":8,"attack":21,"range":3,"special":"ירי רסיסים באוויר","specialEn":"Aerial shard volley","dnaCost":85,"biomassCost":44,"researchTier":4,"size":7},{"id":"mire-newt","nameHe":"טריטון-ביצה","nameEn":"Mire Newt","tags":["burrower","control"],"hp":66,"speed":4,"attack":12,"range":2,"special":"בוץ מלכד רגליים","specialEn":"Mire traps feet","dnaCost":57,"biomassCost":36,"researchTier":3,"size":2},{"id":"solar-tortoise","nameHe":"צב-שמש","nameEn":"Solar Tortoise","tags":["tank","support"],"hp":185,"speed":2,"attack":18,"range":2,"special":"שריון שמש מחמם בעלות","specialEn":"Sun shell warms allies","dnaCost":102,"biomassCost":40,"researchTier":5,"size":8},{"id":"rift-hawk","nameHe":"נץ-בקע","nameEn":"Rift Hawk","tags":["flyer","artillery"],"hp":97,"speed":8,"attack":30,"range":5,"special":"צלילת בקע רחוקה","specialEn":"Rift dive long shot","dnaCost":99,"biomassCost":68,"researchTier":5,"size":9}]`).map(e=>({id:e.id,name:e.nameEn,nameHebrew:e.nameHe,role:e.tags[0]||`combat`,hp:e.hp,speed:e.speed,attack:e.attack,range:e.range,vision:5,special:e.special,primaryColor:Fl(e.id,0),secondaryColor:Fl(e.id,1),costDNA:e.dnaCost,costBiomass:e.biomassCost,size:e.size,researchTier:e.researchTier}));function Fl(e,t){let n=t;for(let t=0;t<e.length;t++)n=e.charCodeAt(t)+((n<<5)-n);return`hsl(${Math.abs(n%360)}, ${60+Math.abs(n)%30}%, ${40+Math.abs(n>>4)%20}%)`}var Il=class{static createHybrid(e,t){let n=Math.round((e.hp+t.hp)/2),r=Math.round((e.speed+t.speed)/2);Math.abs(e.speed-t.speed)>=5&&(r+=1);let i=Math.round((e.attack+t.attack)/2*1.1),a=Math.max(e.range,t.range),o=Math.max(e.vision,t.vision),s=e.attack>=t.attack?e:t,c=e.attack>=t.attack?t:e,l=s.special,u=c.special,d=this.generateHybridName(e,t),f=Math.round((e.costDNA+t.costDNA)*.85),p=Math.round((e.costBiomass+t.costBiomass)*.5),m=Math.max(e.size,t.size),h=Math.max(e.researchTier,t.researchTier);return{id:`hybrid_${e.id}_${t.id}_${Date.now()}`,parent1:e,parent2:t,name:d,hp:n,speed:r,attack:i,range:a,vision:o,specialPrimary:l,specialSecondary:u,primaryColor:e.primaryColor,secondaryColor:t.primaryColor,costDNA:f,costBiomass:p,size:m,researchTier:h}}static generateHybridName(e,t){return e.name.substring(0,Math.ceil(e.name.length/2))+t.name.substring(Math.floor(t.name.length/2))}},Ll=class{container;gameOverEl=null;helpOverlay=null;trainPanel=null;buildPanel=null;placementBanner=null;trainPanelVisible=!1;buildPanelVisible=!1;trainCallbacks=null;trainPanelUnits=[];constructor(){this.container=document.createElement(`div`),this.container.id=`game-ui`,this.container.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
      ...
      direction: rtl;
      z-index: 1000;
    `,this.createTitleBar(),this.createResourcesPanel(),this.createHPBarsPanel(),this.createTrainPanel(),this.createBuildPanel(),this.createSelectionPanel(),this.container.style.display=`none`}createTitleBar(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute;
      top: 20px;
      left: 50%;
    ...
    `,e.textContent=Nl.battle.title,this.container.appendChild(e)}createResourcesPanel(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute;
      top: 60px;
      left: 50%;
      transform: translateX(-50%);
      ...
      font-size: 14px;
      font-weight: bold;
    `;let t=document.createElement(`div`);t.id=`biomass-display`,t.style.color=`#22C55E`,e.appendChild(t);let n=document.createElement(`div`);return n.id=`dna-display`,n.style.color=`#9b59b6`,e.appendChild(n),this.container.appendChild(e),e}createHPBarsPanel(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute;
      top: 100px;
      width: 100%;
      display: flex;
    ...
    `;let t=document.createElement(`div`);t.style.cssText=`
      ...
      gap: 10px;
    `;let n=document.createElement(`div`);n.textContent=Nl.deploy.you,n.style.cssText=`
      color: ${$.playerHex};
      font-size: 18px;
      font-weight: bold;
      text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.8);
    `,t.appendChild(n);let r=document.createElement(`div`);r.textContent=Nl.economy.hq,r.style.cssText=`
      color: #ffffff;
      font-size: 14px;
      margin-bottom: 2px;
    `,t.appendChild(r);let i=document.createElement(`div`);i.id=`player-hq-hp-bar`,i.style.cssText=`
      width: 200px;
      height: 16px;
      ...
      overflow: hidden;
      margin-bottom: 10px;
    `,t.appendChild(i);let a=document.createElement(`div`);a.textContent=`צבא`,a.style.cssText=`
      color: #ffffff;
      font-size: 14px;
      margin-bottom: 2px;
    `,t.appendChild(a);let o=document.createElement(`div`);o.id=`player-hp-bar`,o.style.cssText=`
      width: 200px;
      height: 16px;
      background: rgba(0, 0, 0, 0.5);
      border-radius: 4px;
      overflow: hidden;
    `,t.appendChild(o);let s=document.createElement(`div`);s.style.cssText=`
      display: flex;
      flex-direction: column;
      align-items: flex-end;
      gap: 10px;
    `;let c=document.createElement(`div`);c.textContent=Nl.deploy.rival,c.style.cssText=`
      color: ${$.rivalHex};
      font-size: 18px;
      font-weight: bold;
      text-shadow: 1px 1px 3px rgba(0, 0, 0, 0.8);
    `,s.appendChild(c);let l=document.createElement(`div`);l.textContent=Nl.economy.hq,l.style.cssText=`
      color: #ffffff;
      font-size: 14px;
      margin-bottom: 2px;
    `,s.appendChild(l);let u=document.createElement(`div`);u.id=`enemy-hq-hp-bar`,u.style.cssText=`
      width: 200px;
      height: 16px;
      background: rgba(0, 0, 0, 0.5);
      border-radius: 4px;
      overflow: hidden;
      margin-bottom: 10px;
    `,s.appendChild(u);let d=document.createElement(`div`);d.textContent=`צבא`,d.style.cssText=`
      color: #ffffff;
      font-size: 14px;
      margin-bottom: 2px;
    `,s.appendChild(d);let f=document.createElement(`div`);return f.id=`enemy-hp-bar`,f.style.cssText=`
      width: 200px;
      height: 16px;
      background: rgba(0, 0, 0, 0.5);
      border-radius: 4px;
      overflow: hidden;
    `,s.appendChild(f),e.appendChild(t),e.appendChild(s),this.container.appendChild(e),e}createTrainPanel(){let e=document.createElement(`div`);e.id=`train-panel-container`,e.style.cssText=`
      position: absolute;
      bottom: 80px;
      right: 20px;
      width: 180px;
      ...
      pointer-events: auto;
      display: none;
    `;let t=document.createElement(`div`);t.textContent=Nl.panel.train,t.style.cssText=`
      font-size: 18px;
      font-weight: bold;
      color: #ffffff;
      text-align: center;
      margin-bottom: 15px;
    `,e.appendChild(t);let n=document.createElement(`div`);n.id=`train-units-container`,e.appendChild(n),this.container.appendChild(e),this.trainPanel=e;let r=document.createElement(`div`);r.id=`train-panel-hint`,r.textContent=`לחץ על הבסיס שלך`,r.style.cssText=`
      position: absolute;
      bottom: 120px;
      right: 20px;
      background: rgba(0, 0, 0, 0.85);
      ...
      font-size: 18px;
      font-weight: bold;
      text-shadow: 0 0 10px ${$.player};
      box-shadow: 0 0 20px ${$.player}40;
    `,this.container.appendChild(r);let i=document.createElement(`style`);return i.textContent=`
    ...
    `,document.head.appendChild(i),e}createBuildPanel(){let e=document.createElement(`div`);e.id=`build-panel-container`,e.style.cssText=`
      position: absolute;
      bottom: 80px;
      right: 220px;
      width: 200px;
      ...
      pointer-events: auto;
      display: none;
    `;let t=document.createElement(`div`);t.textContent=`בנייה`,t.style.cssText=`
      font-size: 18px;
      font-weight: bold;
      color: #ffffff;
      text-align: center;
      margin-bottom: 15px;
    `,e.appendChild(t);let n=document.createElement(`div`);return n.id=`build-buttons-container`,e.appendChild(n),this.container.appendChild(e),this.buildPanel=e,e}createSelectionPanel(){let e=document.createElement(`div`);e.style.cssText=`
      position: absolute;
      bottom: 20px;
      left: 50%;
      transform: translateX(-50%);
      ...
      align-items: center;
      justify-content: space-between;
    `;let t=document.createElement(`div`);t.id=`selection-text`,t.style.cssText=`
      font-size: 16px;
      color: #cccccc;
    `,t.textContent=Nl.battle.noneSelected,e.appendChild(t);let n=document.createElement(`div`);return n.id=`selection-hp`,n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
    `,e.appendChild(n),this.container.appendChild(e),e}show(){document.body.appendChild(this.container),this.container.style.display=`block`}hide(){this.container.style.display=`none`,this.container.parentNode&&this.container.parentNode.removeChild(this.container)}updateResources(e){let t=document.getElementById(`biomass-display`),n=document.getElementById(`dna-display`);t&&(t.textContent=`${Nl.economy.biomass}: ${e.biomass}`),n&&(n.textContent=`${Nl.economy.dna}: ${e.dna}`)}showTrainPanel(e,t,n){if(!this.trainPanel)return;let r=document.getElementById(`train-panel-hint`);r&&(r.style.display=`none`),this.trainPanel.style.display=`block`,this.trainPanelVisible=!0,this.setupTrainPanel(e,t,n)}hideTrainPanel(){if(!this.trainPanel)return;let e=document.getElementById(`train-panel-hint`);e&&(e.style.display=`block`),this.trainPanel.style.display=`none`,this.trainPanelVisible=!1}showBuildPanel(e,t){this.buildPanel&&(this.buildPanel.style.display=`block`,this.buildPanelVisible=!0,this.setupBuildPanel(e,t))}hideBuildPanel(){this.buildPanel&&(this.buildPanel.style.display=`none`,this.buildPanelVisible=!1)}setupBuildPanel(e,t){let n=this.buildPanel?.querySelector(`#build-buttons-container`);if(!n)return;n.innerHTML=``;let r=[{type:`Camp`,name:Nl.build.camp,dna:50,biomass:75},{type:`ProductionCell`,name:Nl.build.cell,dna:80,biomass:100},{type:`EnergyMast`,name:Nl.build.mast,dna:60,biomass:50}];for(let i of r){let r=e.dna>=i.dna&&e.biomass>=i.biomass,a=document.createElement(`div`);a.style.cssText=`
        width: 180px;
        height: 50px;
        margin-bottom: 10px;
        background: ${r?`rgba(45, 212, 191, 0.8)`:`rgba(102, 102, 102, 0.8)`};
        border-radius: 6px;
        display: flex;
        flex-direction: column;
        align-items: center;
        ...
        transition: all 0.2s;
      `,r&&(a.addEventListener(`mouseenter`,()=>{a.style.background=`rgba(45, 212, 191, 1)`}),a.addEventListener(`mouseleave`,()=>{a.style.background=`rgba(45, 212, 191, 0.8)`}),a.addEventListener(`click`,()=>{t(i.type)}));let o=document.createElement(`div`);o.textContent=i.name,o.style.cssText=`
        font-size: 13px;
        font-weight: bold;
        color: ${r?`#ffffff`:`#888888`};
      `,a.appendChild(o);let s=document.createElement(`div`);s.textContent=`${i.dna}D ${i.biomass}B`,s.style.cssText=`
        font-size: 11px;
        color: ${r?`#ffffff`:`#666666`};
      `,a.appendChild(s),n.appendChild(a)}}refreshBuildPanel(e,t){this.buildPanelVisible&&this.setupBuildPanel(e,t)}setupTrainPanel(e,t,n){this.trainCallbacks=n;let r=[{name:Nl.panel.worker,cost:{dna:Q.WORKER_COST_DNA,biomass:Q.WORKER_COST_BIOMASS},type:`worker`}],i=e.filter(e=>e.parent1.researchTier<=2&&e.parent2.researchTier<=2).slice(0,3);for(let e of i)r.push({name:e.name,cost:{dna:e.costDNA,biomass:e.costBiomass},type:`unit`,hybrid:e});if(r.length<4){let e=Pl.filter(e=>e.researchTier<=2&&e.role===`combat`).slice(0,4-r.length);for(let t of e)r.push({name:t.nameHebrew,cost:{dna:t.costDNA,biomass:t.costBiomass},type:`archetype`,archetype:t})}this.trainPanelUnits=r,this.renderTrainPanel(t)}renderTrainPanel(e){let t=document.getElementById(`train-units-container`);if(t){t.innerHTML=``;for(let n=0;n<this.trainPanelUnits.length;n++){let r=this.trainPanelUnits[n],i=e.dna>=r.cost.dna&&e.biomass>=r.cost.biomass,a=document.createElement(`div`);a.style.cssText=`
        width: 160px;
        height: 50px;
        margin-bottom: 10px;
        background: ${i?`rgba(45, 212, 191, 0.8)`:`rgba(102, 102, 102, 0.8)`};
        border-radius: 6px;
        display: flex;
        flex-direction: column;
        align-items: center;
        ...
        transition: all 0.2s;
      `,i&&(a.addEventListener(`mouseenter`,()=>{a.style.background=`rgba(45, 212, 191, 1)`}),a.addEventListener(`mouseleave`,()=>{a.style.background=`rgba(45, 212, 191, 0.8)`}),a.addEventListener(`click`,()=>{this.trainCallbacks&&(r.type===`worker`?this.trainCallbacks.onTrainWorker():r.type===`unit`&&r.hybrid?this.trainCallbacks.onTrainUnit(r.hybrid):r.type===`archetype`&&r.archetype&&this.trainCallbacks.onTrainArchetype(r.archetype))}));let o=document.createElement(`div`);o.textContent=r.name,o.style.cssText=`
        font-size: 13px;
        font-weight: bold;
        color: ${i?`#ffffff`:`#888888`};
      `,a.appendChild(o);let s=document.createElement(`div`);s.textContent=`${r.cost.dna}D ${r.cost.biomass}B`,s.style.cssText=`
        font-size: 11px;
        color: ${i?`#ffffff`:`#666666`};
      `,a.appendChild(s),t.appendChild(a)}}}refreshTrainPanel(e){this.trainPanelVisible&&this.renderTrainPanel(e)}updateHQHP(e,t){let n=document.getElementById(`player-hq-hp-bar`),r=document.getElementById(`enemy-hq-hp-bar`);if(!n||!r)return;let i=e.currentHp/e.maxHp,a=t.currentHp/t.maxHp,o=$.playerHex,s=$.rivalHex;n.innerHTML=`
      <div style="width: ${i*100}%; height: 100%; background: ${o}; transition: width 0.3s;"></div>
    `,r.innerHTML=`
      <div style="width: ${a*100}%; height: 100%; background: ${s}; transition: width 0.3s;"></div>
    `}updateSelection(e){let t=document.getElementById(`selection-text`),n=document.getElementById(`selection-hp`);if(t&&n){if(e.length===0)t.textContent=Nl.battle.noneSelected,t.style.color=`#aaaaaa`,n.innerHTML=``;else if(e.length===1){let r=e[0];t.textContent=`${Nl.battle.selected}: ${r.creature.name}`,t.style.color=$.playerHex;let i=r.currentHp/r.creature.hp,a=i>.5?`#00ff00`:i>.25?`#ffff00`:`#ff0000`;n.innerHTML=`
        <div style="font-size: 16px; color: #ffffff;">
          ${Nl.stat.hp}: ${r.currentHp}/${r.creature.hp}
        </div>
        <div style="width: 150px; height: 8px; background: rgba(0,0,0,0.5); border-radius: 4px; overflow: hidden;">
          <div style="width: ${i*100}%; height: 100%; background: ${a};"></div>
        </div>
      `}else t.textContent=`${Nl.battle.selected}: ${e.length} יחידות`,t.style.color=$.playerHex,n.innerHTML=``}}updateHPBars(e,t){let n=document.getElementById(`player-hp-bar`),r=document.getElementById(`enemy-hp-bar`);if(!n||!r)return;let i=e.reduce((e,t)=>e+t.creature.hp,0),a=e.reduce((e,t)=>e+t.currentHp,0),o=i>0?a/i:0,s=t.reduce((e,t)=>e+t.creature.hp,0),c=t.reduce((e,t)=>e+t.currentHp,0),l=s>0?c/s:0,u=$.playerHex,d=$.rivalHex;n.innerHTML=`
      <div style="width: ${o*100}%; height: 100%; background: ${u}; transition: width 0.3s;"></div>
    `,r.innerHTML=`
      <div style="width: ${l*100}%; height: 100%; background: ${d}; transition: width 0.3s;"></div>
    `}showGameOver(e,t){if(this.gameOverEl)return;this.gameOverEl=document.createElement(`div`),this.gameOverEl.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
      ...
      z-index: 2000;
      pointer-events: auto;
    `,this.gameOverEl.addEventListener(`keydown`,e=>{e.code===`Escape`&&(e.preventDefault(),e.stopPropagation())},!0);let n=document.createElement(`div`);n.textContent=e?Nl.win.title:Nl.lose.title,n.style.cssText=`
      font-size: 64px;
      font-weight: bold;
      color: ${e?`#22C55E`:`#EF4444`};
      margin-bottom: 20px;
      text-shadow: 3px 3px 6px rgba(0, 0, 0, 0.8);
    `,this.gameOverEl.appendChild(n);let r=document.createElement(`div`);r.textContent=t,r.style.cssText=`
      font-size: 24px;
      color: #ffffff;
      margin-bottom: 40px;
    `,this.gameOverEl.appendChild(r);let i=document.createElement(`div`);i.style.cssText=`
      display: flex;
      gap: 20px;
    `;let a=document.createElement(`button`);a.textContent=Nl.gameOver.anotherBattle,a.style.cssText=`
      padding: 15px 30px;
      font-size: 18px;
      font-weight: bold;
      ...
      cursor: pointer;
      transition: all 0.2s;
    `,a.addEventListener(`mouseenter`,()=>{a.style.transform=`scale(1.1)`}),a.addEventListener(`mouseleave`,()=>{a.style.transform=`scale(1)`}),a.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`battle-rematch`))}),i.appendChild(a);let o=document.createElement(`button`);o.textContent=Nl.gameOver.backToCage,o.style.cssText=`
      padding: 15px 30px;
      font-size: 18px;
      font-weight: bold;
      background: #64748B;
      ...
      cursor: pointer;
      transition: all 0.2s;
    `,o.addEventListener(`mouseenter`,()=>{o.style.transform=`scale(1.1)`}),o.addEventListener(`mouseleave`,()=>{o.style.transform=`scale(1)`}),o.addEventListener(`click`,()=>{window.dispatchEvent(new CustomEvent(`navigate-to-cage`))}),i.appendChild(o),this.gameOverEl.appendChild(i),this.container&&(this.container.style.zIndex=`100`),document.body.appendChild(this.gameOverEl)}toggleHelpOverlay(){this.helpOverlay?this.closeHelpOverlay():this.showHelpOverlay()}isHelpOverlayOpen(){return this.helpOverlay!==null}closeHelpOverlay(){this.helpOverlay&&=(document.body.removeChild(this.helpOverlay),null)}closeGameOver(){this.gameOverEl&&(document.body.removeChild(this.gameOverEl),this.gameOverEl=null,this.container&&(this.container.style.zIndex=`1000`))}showHelpOverlay(){if(this.helpOverlay)return;this.helpOverlay=document.createElement(`div`),this.helpOverlay.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      background: rgba(0, 0, 0, 0.95);
      border: 2px solid ${$.playerHex};
      border-radius: 12px;
      padding: 30px;
      max-width: 600px;
      z-index: 3000;
      pointer-events: auto;
    `;let e=document.createElement(`div`);e.textContent=`עזרה - בקרים`,e.style.cssText=`
      font-size: 28px;
      font-weight: bold;
      color: ${$.playerHex};
      text-align: center;
      margin-bottom: 20px;
    `,this.helpOverlay.appendChild(e);for(let e of[{key:`WASD / חצים`,action:`הזז מצלמה`},{key:`גלגל עכבר`,action:`זום`},{key:`קצה מסך`,action:`הזז מצלמה אוטומטי`},{key:`לחיצה שמאלית`,action:`בחר יחידה`},{key:`גרירה שמאלית`,action:`בחר מרובע`},{key:`לחיצה ימנית`,action:`הזז / תקוף`},{key:`לחץ על בסיס שלך`,action:`הצג פאנל אימון`},{key:`רווח (Space)`,action:`מרכז על בחירה`},{key:`F1`,action:`עזרה`},{key:`Esc`,action:`סגור / בטל בחירה`}]){let t=document.createElement(`div`);t.style.cssText=`
        display: flex;
        justify-content: space-between;
        margin-bottom: 12px;
        gap: 20px;
      `;let n=document.createElement(`span`);n.textContent=e.key,n.style.cssText=`
        color: #ffffff;
        font-weight: bold;
        font-size: 16px;
      `;let r=document.createElement(`span`);r.textContent=e.action,r.style.cssText=`
        color: #cccccc;
        font-size: 16px;
      `,t.appendChild(n),t.appendChild(r),this.helpOverlay.appendChild(t)}let t=document.createElement(`button`);t.textContent=`סגור (Esc)`,t.style.cssText=`
      margin-top: 20px;
      padding: 10px 30px;
      background: ${$.playerHex};
      color: #000000;
      ...
      cursor: pointer;
      width: 100%;
    `,t.addEventListener(`click`,()=>this.closeHelpOverlay()),this.helpOverlay.appendChild(t),document.body.appendChild(this.helpOverlay)}showPlacementBanner(){this.placementBanner||(this.placementBanner=document.createElement(`div`),this.placementBanner.id=`placement-banner`,this.placementBanner.textContent=Nl.build.place,this.placementBanner.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      background: rgba(0, 0, 0, 0.9);
      border: 3px solid ${$.playerHex};
      border-radius: 10px;
      padding: 20px 40px;
      font-size: 24px;
      font-weight: bold;
      color: ${$.playerHex};
      text-shadow: 0 0 10px ${$.playerHex};
      box-shadow: 0 0 20px ${$.playerHex}40;
      z-index: 2500;
      pointer-events: none;
    `,document.body.appendChild(this.placementBanner))}hidePlacementBanner(){this.placementBanner&&=(document.body.removeChild(this.placementBanner),null)}},Rl=class{canvas;ctx;container;mapWidth;mapHeight;minimapSize=180;constructor(e,t){this.mapWidth=e,this.mapHeight=t,this.container=document.createElement(`div`),this.container.style.cssText=`
      position: fixed;
      bottom: 80px;
      left: 20px;
      ...
      cursor: pointer;
      pointer-events: auto;
    `,this.canvas=document.createElement(`canvas`),this.canvas.width=this.minimapSize,this.canvas.height=this.minimapSize,this.canvas.style.width=`100%`,this.canvas.style.height=`100%`,this.container.appendChild(this.canvas),this.ctx=this.canvas.getContext(`2d`),this.canvas.addEventListener(`click`,this.onMinimapClick.bind(this))}onMinimapClick(e){let t=this.canvas.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height,i=n*this.mapWidth,a=r*this.mapHeight;this.container.dispatchEvent(new CustomEvent(`minimap-click`,{detail:{x:i,z:a}}))}update(e,t,n,r,i,a){this.ctx.fillStyle=`#1a3a1a`,this.ctx.fillRect(0,0,this.minimapSize,this.minimapSize),this.ctx.fillStyle=`#22C55E`;for(let e of a){if(e.isEmpty())continue;let t=e.x/this.mapWidth*this.minimapSize,n=e.y/this.mapHeight*this.minimapSize;this.ctx.fillRect(t-2,n-2,4,4)}this.ctx.fillStyle=`#2DD4BF`;let o=r.x/this.mapWidth*this.minimapSize,s=r.y/this.mapHeight*this.minimapSize;this.ctx.fillRect(o-4,s-4,8,8),this.ctx.fillStyle=`#F97316`;let c=i.x/this.mapWidth*this.minimapSize,l=i.y/this.mapHeight*this.minimapSize;this.ctx.fillRect(c-4,l-4,8,8),this.ctx.fillStyle=`#2DD4BF`;for(let t of e){let e=t.getPosition(),n=e.x/this.mapWidth*this.minimapSize,r=e.z/this.mapHeight*this.minimapSize;this.ctx.fillRect(n-1,r-1,2,2)}this.ctx.fillStyle=`#F97316`;for(let e of t){let t=e.getPosition(),n=t.x/this.mapWidth*this.minimapSize,r=t.z/this.mapHeight*this.minimapSize;this.ctx.fillRect(n-1,r-1,2,2)}this.ctx.strokeStyle=`#ffffff`,this.ctx.lineWidth=1,this.ctx.strokeRect(this.minimapSize*.3,this.minimapSize*.3,this.minimapSize*.4,this.minimapSize*.4)}show(){this.container.parentNode||document.body.appendChild(this.container)}hide(){this.container.parentNode&&this.container.parentNode.removeChild(this.container)}onMinimapClickCallback(e){this.container.addEventListener(`minimap-click`,(t=>{e(t.detail.x,t.detail.z)}))}destroy(){this.hide()}},zl=class{scene;inputManager;uiManager;camera;minimap;playerUnits=[];enemyUnits=[];selectedUnits=[];playerHQ;enemyHQ;resourceNodes=[];playerResources={biomass:0,dna:0};enemyResources={biomass:0,dna:0};dnaTrickleTimer=0;armyRoster=[];gameEnded=!1;aiUpdateTimer=0;playerBuildings=[];placementMode={active:!1,buildingType:null,ghostMesh:null,isValid:!1,cost:{dna:0,biomass:0}};MAP_WIDTH=Q.MAP_WIDTH;MAP_HEIGHT=Q.MAP_HEIGHT;constructor(e,t,n){this.scene=e,this.inputManager=t,this.camera=n,this.uiManager=new Ll,this.minimap=new Rl(this.MAP_WIDTH,this.MAP_HEIGHT),this.setupInputCallbacks(),this.setupKeyboardShortcuts(),window.addEventListener(`battle-rematch`,this.handleBattleRematch.bind(this)),this.scene.addEventListener(`resource-gathered`,this.onResourceGathered.bind(this))}setupInputCallbacks(){this.inputManager.on(`leftclick`,(e,t)=>{if(!this.gameEnded){if(this.placementMode.active){this.confirmPlacement(e);return}this.handleLeftClick(e,t)}}),this.inputManager.on(`rightclick`,e=>{if(!this.gameEnded){if(this.placementMode.active){this.cancelPlacement();return}this.handleRightClick(e)}}),this.inputManager.on(`boxselect`,(e,t,n)=>{this.gameEnded||this.handleBoxSelect(e,t,n)}),this.minimap.onMinimapClickCallback((e,t)=>{this.gameEnded||this.camera.panTo(e,t)}),this.inputManager.on(`hover`,e=>{this.placementMode.active&&e&&this.updateGhostPosition(e)})}setupKeyboardShortcuts(){window.addEventListener(`keydown`,e=>{this.gameEnded||(e.code===`Space`&&this.selectedUnits.length>0&&(e.preventDefault(),this.centerCameraOnSelection()),e.code===`F1`&&(e.preventDefault(),this.uiManager.toggleHelpOverlay(),this.camera.setHelpOverlayOpen(this.uiManager.isHelpOverlayOpen())),e.code===`Escape`&&(this.uiManager.isHelpOverlayOpen()?(this.uiManager.closeHelpOverlay(),this.camera.setHelpOverlayOpen(!1)):this.clearSelection()),e.code===`KeyK`&&window.location.search.includes(`debug=1`)&&(e.preventDefault(),this.gameEnded||(this.gameEnded=!0,this.uiManager.showGameOver(!0,Nl.win.destroyBase))))})}centerCameraOnSelection(){if(this.selectedUnits.length===0)return;let e=0,t=0;for(let n of this.selectedUnits){let r=n.getPosition();e+=r.x,t+=r.z}let n=e/this.selectedUnits.length,r=t/this.selectedUnits.length;this.camera.panTo(n,r)}start(e=null){this.playerResources={biomass:Q.STARTING_BIOMASS,dna:Q.STARTING_DNA},this.enemyResources={biomass:Q.STARTING_BIOMASS,dna:Q.STARTING_DNA},e?this.armyRoster=[e]:this.createDefaultArmyRoster(),this.spawnHQs(),this.spawnResourceNodes(),this.spawnWorkers(),this.spawnPlayerArmy(this.armyRoster[0]),this.spawnEnemyArmy();let t=this.playerHQ.x,n=this.playerHQ.y;this.camera.frameView(t+30,n,60),this.uiManager.show(),this.uiManager.updateResources(this.playerResources),this.uiManager.updateHQHP(this.playerHQ,this.enemyHQ),this.uiManager.hideTrainPanel(),this.minimap.show(),this.gameEnded=!1}handleBattleRematch(){console.log(`[GameManager] Handling battle rematch - full reset`);let e=this.armyRoster.length>0?this.armyRoster[0]:null;this.uiManager.closeGameOver();for(let e of[...this.playerUnits,...this.enemyUnits])e.destroy();this.playerUnits=[],this.enemyUnits=[],this.selectedUnits=[],this.playerHQ.destroy(),this.enemyHQ.destroy();for(let e of this.resourceNodes)e.destroy();this.resourceNodes=[];for(let e of this.playerBuildings)e.destroy();this.playerBuildings=[],this.dnaTrickleTimer=0,this.aiUpdateTimer=0,this.start(e),console.log(`[GameManager] Battle rematch complete`)}createDefaultArmyRoster(){let e=Pl.find(e=>e.id===`bat-echo`),t=Pl.find(e=>e.id===`horn-deer`),n=Pl.find(e=>e.id===`quill-snake`);this.armyRoster=[Il.createHybrid(e,t),Il.createHybrid(n,e),Il.createHybrid(t,n)]}spawnHQs(){this.playerHQ=new jl(this.scene,new G(20,0,this.MAP_HEIGHT/2),`player`,`HQ`),this.enemyHQ=new jl(this.scene,new G(this.MAP_WIDTH-20,0,this.MAP_HEIGHT/2),`enemy`,`HQ`)}spawnResourceNodes(){let e=[{id:`b1`,type:`biomass`,x:40,y:40,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT},{id:`b2`,type:`biomass`,x:50,y:this.MAP_HEIGHT-40,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT},{id:`b3`,type:`biomass`,x:this.MAP_WIDTH/2,y:35,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT},{id:`b4`,type:`biomass`,x:this.MAP_WIDTH/2,y:this.MAP_HEIGHT-35,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT},{id:`b5`,type:`biomass`,x:this.MAP_WIDTH-40,y:40,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT},{id:`b6`,type:`biomass`,x:this.MAP_WIDTH-50,y:this.MAP_HEIGHT-40,amount:Q.RESOURCE_NODE_BIOMASS_AMOUNT,maxAmount:Q.RESOURCE_NODE_BIOMASS_AMOUNT}];for(let t of e){let e=new Ml(this.scene,t);this.resourceNodes.push(e)}}spawnWorkers(){for(let e=0;e<Q.STARTING_WORKERS;e++){let t=e/Q.STARTING_WORKERS*Math.PI*2,n=new G(this.playerHQ.x+Math.cos(t)*8,0,this.playerHQ.y+Math.sin(t)*8),r=this.createWorkerCreature(),i=new Al(this.scene,n,r,`player`,`worker`,this.playerHQ);this.playerUnits.push(i)}for(let e=0;e<Q.STARTING_WORKERS;e++){let t=e/Q.STARTING_WORKERS*Math.PI*2,n=new G(this.enemyHQ.x+Math.cos(t)*8,0,this.enemyHQ.y+Math.sin(t)*8),r=this.createWorkerCreature(),i=new Al(this.scene,n,r,`enemy`,`worker`,this.enemyHQ);this.enemyUnits.push(i)}}createWorkerCreature(){return{id:`worker`,parent1:Pl[0],parent2:Pl[1],name:`עובד`,hp:50,speed:5,attack:1,range:1,vision:6,specialPrimary:``,specialSecondary:``,primaryColor:`#FACC15`,secondaryColor:`#854D0E`,costDNA:0,costBiomass:0,size:3,researchTier:1}}spawnPlayerArmy(e){let t=this.playerHQ.x+15,n=this.playerHQ.y;for(let r=0;r<3;r++){let i=Math.floor(r/2),a=new G(t+r%2*7,0,n-5+i*7),o=new Al(this.scene,a,e,`player`,`combat`);this.playerUnits.push(o)}}spawnEnemyArmy(){let e=this.enemyHQ.x-15,t=this.enemyHQ.y;for(let n=0;n<2;n++){let r=Pl[Math.floor(Math.random()*Pl.length)],i=Pl[Math.floor(Math.random()*Pl.length)],a=Il.createHybrid(r,i),o=new G(e-n%2*7,0,t-5+Math.floor(n/2)*7),s=new Al(this.scene,o,a,`enemy`,`combat`);this.enemyUnits.push(s)}}handleLeftClick(e,t){if(this.getHQAtPosition(e)===this.playerHQ){t||this.clearSelection(),this.uiManager.showTrainPanel(this.armyRoster,this.playerResources,{onTrainWorker:()=>this.trainWorker(),onTrainUnit:e=>this.trainCombatUnit(e),onTrainArchetype:e=>this.trainArchetype(e)}),this.uiManager.hideBuildPanel(),this.updateSelectionUI();return}let n=this.getUnitAtPosition(e);if(n&&n.team===`player`){if(!t)this.clearSelection();else if(this.selectedUnits.includes(n)){n.setSelected(!1),this.selectedUnits=this.selectedUnits.filter(e=>e!==n),this.updatePanelVisibility();return}n.setSelected(!0),this.selectedUnits.includes(n)||this.selectedUnits.push(n),this.updatePanelVisibility()}else t||(this.clearSelection(),this.uiManager.hideTrainPanel(),this.uiManager.hideBuildPanel());this.updateSelectionUI()}updatePanelVisibility(){this.selectedUnits.some(e=>e.role===`worker`)?(this.uiManager.showBuildPanel(this.playerResources,e=>{this.startBuildingPlacement(e)}),this.uiManager.hideTrainPanel()):(this.uiManager.hideBuildPanel(),this.uiManager.hideTrainPanel())}getHQAtPosition(e){let t=e.distanceTo(this.playerHQ.getPosition()),n=e.distanceTo(this.enemyHQ.getPosition());return t<10?this.playerHQ:n<10?this.enemyHQ:null}handleRightClick(e){if(this.selectedUnits.length===0)return;let t=this.getHQAtPosition(e);if(t&&t===this.enemyHQ){let e=this.selectedUnits.filter(e=>e.role===`combat`);for(let t of e)t.targetEnemy=null,t.moveToPosition(this.enemyHQ.getPosition().x,this.enemyHQ.getPosition().z);return}let n=this.getBuildingAtPosition(e);if(n&&n.buildingState===`constructing`){let e=this.selectedUnits.filter(e=>e.role===`worker`);for(let t of e)t.orderConstruct(n);return}let r=this.getResourceNodeAtPosition(e);if(r&&!r.isEmpty()){let e=this.selectedUnits.filter(e=>e.role===`worker`);for(let t of e)t.orderGather(r);return}let i=this.getUnitAtPosition(e);for(let t of this.selectedUnits)i&&i.team===`enemy`?(t.targetEnemy=i,t.moveToPosition(i.getPosition().x,i.getPosition().z)):(t.targetEnemy=null,t.moveToPosition(e.x,e.z))}handleBoxSelect(e,t,n){n||this.clearSelection();let r=Math.min(e.x,t.x),i=Math.max(e.x,t.x),a=Math.min(e.z,t.z),o=Math.max(e.z,t.z);for(let e of this.playerUnits){let t=e.getPosition();t.x>=r&&t.x<=i&&t.z>=a&&t.z<=o&&(e.setSelected(!0),this.selectedUnits.includes(e)||this.selectedUnits.push(e))}this.updateSelectionUI()}getUnitAtPosition(e){let t=[...this.playerUnits,...this.enemyUnits];for(let n of t)if(e.distanceTo(n.getPosition())<3)return n;return null}getResourceNodeAtPosition(e){for(let t of this.resourceNodes)if(e.distanceTo(t.getPosition())<4)return t;return null}getBuildingAtPosition(e){for(let t of this.playerBuildings)if(e.distanceTo(t.getPosition())<8)return t;return null}clearSelection(){for(let e of this.selectedUnits)e.setSelected(!1);this.selectedUnits=[],this.updateSelectionUI()}updateSelectionUI(){this.uiManager.updateSelection(this.selectedUnits)}onResourceGathered(e){e.team===`player`?(this.playerResources.biomass+=e.amount,this.updateResourceUI()):this.enemyResources.biomass+=e.amount}updateResourceUI(){this.uiManager.updateResources(this.playerResources),this.uiManager.updateHQHP(this.playerHQ,this.enemyHQ),this.uiManager.refreshTrainPanel(this.playerResources)}trainWorker(){if(this.playerResources.dna>=Q.WORKER_COST_DNA&&this.playerResources.biomass>=Q.WORKER_COST_BIOMASS){this.playerResources.dna-=Q.WORKER_COST_DNA,this.playerResources.biomass-=Q.WORKER_COST_BIOMASS,this.updateResourceUI();let e=Math.random()*Math.PI*2,t=new G(this.playerHQ.x+Math.cos(e)*8,0,this.playerHQ.y+Math.sin(e)*8),n=this.createWorkerCreature(),r=new Al(this.scene,t,n,`player`,`worker`,this.playerHQ);this.playerUnits.push(r);let i=this.findNearestResourceNode(r);i&&!i.isEmpty()&&r.orderGather(i)}}findNearestResourceNode(e){let t=null,n=1/0;for(let r of this.resourceNodes){if(r.isEmpty())continue;let i=e.getPosition().distanceTo(r.getPosition());i<n&&(n=i,t=r)}return t}trainCombatUnit(e){if(this.playerResources.dna>=e.costDNA&&this.playerResources.biomass>=e.costBiomass){this.playerResources.dna-=e.costDNA,this.playerResources.biomass-=e.costBiomass,this.updateResourceUI();let t=Math.random()*Math.PI*2,n=new G(this.playerHQ.x+Math.cos(t)*10,0,this.playerHQ.y+Math.sin(t)*10),r=new Al(this.scene,n,e,`player`,`combat`);this.playerUnits.push(r)}}trainArchetype(e){if(this.playerResources.dna>=e.costDNA&&this.playerResources.biomass>=e.costBiomass){this.playerResources.dna-=e.costDNA,this.playerResources.biomass-=e.costBiomass,this.updateResourceUI();let t={id:`archetype_${e.id}_${Date.now()}`,parent1:e,parent2:e,name:e.nameHebrew,hp:e.hp,speed:e.speed,attack:e.attack,range:e.range,vision:e.vision,specialPrimary:e.special,specialSecondary:``,primaryColor:e.primaryColor,secondaryColor:e.secondaryColor,costDNA:e.costDNA,costBiomass:e.costBiomass,size:e.size,researchTier:e.researchTier},n=Math.random()*Math.PI*2,r=new G(this.playerHQ.x+Math.cos(n)*10,0,this.playerHQ.y+Math.sin(n)*10),i=new Al(this.scene,r,t,`player`,`combat`);this.playerUnits.push(i)}}startBuildingPlacement(e){let t={Camp:{dna:50,biomass:75},ProductionCell:{dna:80,biomass:100},EnergyMast:{dna:60,biomass:50}}[e];if(this.playerResources.dna<t.dna||this.playerResources.biomass<t.biomass){console.log(`[GameManager] Cannot afford building:`,e);return}this.placementMode.active=!0,this.placementMode.buildingType=e,this.placementMode.cost=t,this.placementMode.isValid=!1;let n=new Hi(8,6,8),r=new ti({color:16711680,transparent:!0,opacity:.5});this.placementMode.ghostMesh=new Y(n,r),this.placementMode.ghostMesh.position.y=3,this.scene.add(this.placementMode.ghostMesh),this.uiManager.showPlacementBanner(),console.log(`[GameManager] Entered placement mode for ${e}`)}updateGhostPosition(e){this.placementMode.active&&this.placementMode.ghostMesh&&(this.placementMode.ghostMesh.position.x=e.x,this.placementMode.ghostMesh.position.z=e.z,this.placementMode.isValid=this.isValidPlacement(e),this.placementMode.ghostMesh.material.color.setHex(this.placementMode.isValid?65280:16711680))}isValidPlacement(e){if(e.x<15||e.x>this.MAP_WIDTH-15||e.z<15||e.z>this.MAP_HEIGHT-15||e.distanceTo(this.playerHQ.getPosition())<20||e.distanceTo(this.enemyHQ.getPosition())<20)return!1;for(let t of this.playerBuildings)if(e.distanceTo(t.getPosition())<12)return!1;for(let t of this.resourceNodes)if(e.distanceTo(t.getPosition())<10)return!1;return!0}confirmPlacement(e){if(!this.placementMode.active||!this.placementMode.isValid){console.log(`[GameManager] Cannot place building - invalid position`);return}this.playerResources.dna-=this.placementMode.cost.dna,this.playerResources.biomass-=this.placementMode.cost.biomass,this.updateResourceUI();let t=new jl(this.scene,e,`player`,this.placementMode.buildingType,`constructing`);this.playerBuildings.push(t),console.log(`[GameManager] Placed ${this.placementMode.buildingType} at (${e.x.toFixed(1)}, ${e.z.toFixed(1)})`),this.exitPlacementMode()}cancelPlacement(){console.log(`[GameManager] Placement cancelled`),this.exitPlacementMode()}exitPlacementMode(){this.placementMode.active&&(this.placementMode.ghostMesh&&(this.scene.remove(this.placementMode.ghostMesh),this.placementMode.ghostMesh.geometry.dispose(),this.placementMode.ghostMesh.material.dispose(),this.placementMode.ghostMesh=null),this.uiManager.hidePlacementBanner(),this.placementMode.active=!1,this.placementMode.buildingType=null,this.placementMode.isValid=!1,this.placementMode.cost={dna:0,biomass:0},console.log(`[GameManager] Exited placement mode`))}update(e){if(!this.gameEnded){this.dnaTrickleTimer+=e*1e3,this.dnaTrickleTimer>=Q.DNA_TRICKLE_INTERVAL&&(this.dnaTrickleTimer-=Q.DNA_TRICKLE_INTERVAL,this.playerResources.dna+=Q.DNA_TRICKLE_RATE,this.enemyResources.dna+=Q.DNA_TRICKLE_RATE,this.updateResourceUI()),this.playerUnits=this.playerUnits.filter(t=>(t.update(e*1e3),t.currentHp<=0?(t.destroy(),!1):!0)),this.enemyUnits=this.enemyUnits.filter(t=>(t.update(e*1e3),t.currentHp<=0?(t.destroy(),!1):!0)),this.selectedUnits=this.selectedUnits.filter(e=>e.currentHp>0),this.playerHQ.update(),this.enemyHQ.update();for(let t of this.playerBuildings)t.update(),t.advanceConstruction(e*1e3),t.advanceTrainQueue(e*1e3);for(let e of this.resourceNodes)e.update();this.updateCombat(e*1e3),this.updateAI(e*1e3),this.minimap.update(this.playerUnits,this.enemyUnits,this.camera,this.playerHQ,this.enemyHQ,this.resourceNodes),this.checkGameEnd(),this.uiManager.updateHPBars(this.playerUnits,this.enemyUnits),this.scene.userData.cameraPosition=this.scene.userData.cameraPosition||new G}}updateCombat(e){for(let e of[...this.playerUnits,...this.enemyUnits])if(e.role===`combat`){if(e.targetEnemy&&e.targetEnemy.currentHp<=0){let t=e.team===`player`?this.enemyUnits:this.playerUnits,n=e.findNearestEnemy(t.filter(e=>e.role===`combat`));e.targetEnemy=n,n&&e.moveToPosition(n.getPosition().x,n.getPosition().z)}if(e.targetEnemy){let t=e.getPosition().distanceTo(e.targetEnemy.getPosition()),n=e.creature.range*3;t>n&&e.moveToPosition(e.targetEnemy.getPosition().x,e.targetEnemy.getPosition().z),t<=n&&e.attackTarget(e.targetEnemy)}else{let t=e.team===`player`?this.enemyUnits:this.playerUnits,n=e.findNearestEnemy(t.filter(e=>e.role===`combat`));if(n&&e.getPosition().distanceTo(n.getPosition())<=20&&(e.targetEnemy=n,e.moveToPosition(n.getPosition().x,n.getPosition().z)),!e.targetEnemy){let t=e.team===`player`?this.enemyHQ:this.playerHQ;if(e.getPosition().distanceTo(t.getPosition())<=e.creature.range*5&&e.attackCooldown===0){let n=e.creature.attack;t.takeDamage(n),console.log(`[Combat] ${e.team} unit attacking ${t===this.playerHQ?`player`:`enemy`} HQ for ${n} damage. HQ HP: ${t.currentHp}/${t.maxHp}`),e.attackCooldown=1e3}}}}}updateAI(e){if(this.aiUpdateTimer+=e,!(this.aiUpdateTimer<400)){this.aiUpdateTimer=0;for(let e of this.enemyUnits){if(e.role!==`combat`)continue;let t=null,n=1/0;for(let r of this.playerUnits){if(r.role!==`combat`)continue;let i=e.getPosition().distanceTo(r.getPosition());i<n&&i<25&&(n=i,t=r)}t&&!e.targetEnemy&&(e.targetEnemy=t,e.moveToPosition(t.getPosition().x,t.getPosition().z))}}}checkGameEnd(){this.playerHQ.currentHp<=0?(this.gameEnded=!0,console.log(`[GameManager] Player HQ destroyed - showing lose modal`),this.uiManager.showGameOver(!1,Nl.lose.baseDown)):this.enemyHQ.currentHp<=0&&(this.gameEnded=!0,console.log(`[GameManager] Enemy HQ destroyed - showing win modal`),this.uiManager.showGameOver(!0,Nl.win.destroyBase))}dispose(){for(let e of this.playerUnits)e.destroy();for(let e of this.enemyUnits)e.destroy();for(let e of this.resourceNodes)e.destroy();this.playerHQ.destroy(),this.enemyHQ.destroy(),this.uiManager.hide(),this.minimap.destroy()}},Bl=class{mesh;MAP_WIDTH=Q.MAP_WIDTH;MAP_HEIGHT=Q.MAP_HEIGHT;constructor(){this.mesh=new Sn;let e=new Gi(this.MAP_WIDTH,this.MAP_HEIGHT,50,50),t=e.attributes.position;for(let e=0;e<t.count;e++){let n=t.getZ(e),r=(Math.sin(e*.1)+Math.cos(e*.15))*.5;t.setZ(e,n+r)}e.computeVertexNormals();let n=new Y(e,new ia({color:7048781,roughness:.8,metalness:.1,flatShading:!1}));n.rotation.x=-Math.PI/2,n.position.set(this.MAP_WIDTH/2,0,this.MAP_HEIGHT/2),n.receiveShadow=!0,this.mesh.add(n);let r=new co(Math.max(this.MAP_WIDTH,this.MAP_HEIGHT),40,0,0);r.material.opacity=.25,r.material.transparent=!0,r.position.set(this.MAP_WIDTH/2,.15,this.MAP_HEIGHT/2),this.mesh.add(r)}getMesh(){return this.mesh}},Vl=class{renderer;scene;camera;inputManager;gameManager;terrain;clock;isRunning=!1;constructor(e){this.renderer=new Dl({antialias:!0,alpha:!1}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.setClearColor(11591935);let t=this.renderer.domElement;t.style.width=`100%`,t.style.height=`100%`,t.style.display=`block`,e.appendChild(t),this.scene=new jn,this.scene.fog=new An(13684944,100,400),this.camera=new Ol(this.renderer.domElement),this.terrain=new Bl,this.scene.add(this.terrain.getMesh()),this.setupLighting(),this.inputManager=new kl(this.renderer.domElement,this.camera.getCamera(),this.scene),this.gameManager=new zl(this.scene,this.inputManager,this.camera),this.clock=new so,window.addEventListener(`resize`,this.onWindowResize.bind(this))}setupLighting(){let e=new Ba(16777215,.6);this.scene.add(e);let t=new za(16777215,1.2);t.position.set(50,100,50),t.castShadow=!0,t.shadow.camera.left=-150,t.shadow.camera.right=150,t.shadow.camera.top=150,t.shadow.camera.bottom=-150,t.shadow.camera.near=.5,t.shadow.camera.far=300,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.bias=-1e-4,this.scene.add(t);let n=new Sa(11591935,7048781,.5);this.scene.add(n)}onWindowResize(){let e=window.innerWidth,t=window.innerHeight;this.camera.onResize(e,t),this.renderer.setSize(e,t)}start(e=null){this.isRunning=!0,this.gameManager.start(e),this.animate()}animate=()=>{if(!this.isRunning)return;requestAnimationFrame(this.animate);let e=this.clock.getDelta();this.camera.update(e),this.inputManager.update(e),this.gameManager.update(e),this.renderer.render(this.scene,this.camera.getCamera())};dispose(){this.isRunning=!1,this.gameManager.dispose(),this.inputManager.dispose(),this.renderer.dispose(),window.removeEventListener(`resize`,this.onWindowResize.bind(this))}},Hl=class{container=null;selectedAnimal1=null;selectedAnimal2=null;onStartBattle=null;searchQuery=``;currentFilter=`all`;show(e){if(this.container)return;this.onStartBattle=e,this.selectedAnimal1=null,this.selectedAnimal2=null,this.container=document.createElement(`div`),this.container.id=`cage-ui`,this.container.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
    ...
    `;let n=document.createElement(`div`);n.textContent=`כלוב - בחר שני חיות`,n.style.cssText=`
      font-size: 48px;
      font-weight: bold;
      color: ${$.playerHex};
      margin-bottom: 10px;
      text-shadow: 0 0 20px ${$.player}80;
    `,t.appendChild(n);let r=document.createElement(`div`);r.textContent=`100 חיות מקוריות לבחירתך`,r.style.cssText=`
      font-size: 20px;
      color: #ffffff;
    `,t.appendChild(r),this.container.appendChild(t);let i=document.createElement(`div`);i.style.cssText=`
      padding: 20px;
      display: flex;
      gap: 20px;
      justify-content: center;
      align-items: center;
    `;let a=document.createElement(`input`);a.type=`text`,a.placeholder=`חפש חיה...`,a.style.cssText=`
      padding: 12px 20px;
      font-size: 16px;
      border: 2px solid ${$.playerHex};
      border-radius: 8px;
      ...
      direction: rtl;
      width: 300px;
    `,a.addEventListener(`input`,e=>{this.searchQuery=e.target.value.toLowerCase(),this.renderAnimalList()}),i.appendChild(a);let o=this.createFilterButton(`הכל`,`all`),s=this.createFilterButton(`קרב`,`combat`),c=this.createFilterButton(`עובד`,`worker`);i.appendChild(o),i.appendChild(s),i.appendChild(c),this.container.appendChild(i);let l=document.createElement(`div`);l.id=`cage-selection-display`,l.style.cssText=`
      padding: 20px;
      margin: 0 auto;
      max-width: 900px;
      display: flex;
      ...
      justify-content: center;
      align-items: stretch;
    `,this.container.appendChild(l);let u=document.createElement(`div`);u.id=`cage-animal-list`,u.style.cssText=`
      padding: 20px;
      display: grid;
      ...
      max-width: 1400px;
      margin: 0 auto;
    `,this.container.appendChild(u),this.renderSelectionDisplay(),this.renderAnimalList(),document.body.appendChild(this.container)}createFilterButton(e,t){let n=document.createElement(`button`);return n.textContent=e,n.style.cssText=`
      padding: 10px 24px;
      font-size: 16px;
      font-weight: bold;
      background: ${this.currentFilter===t?$.playerHex:`rgba(255, 255, 255, 0.2)`};
      color: ${this.currentFilter===t?`#000000`:`#ffffff`};
      border: 2px solid ${$.playerHex};
      border-radius: 8px;
      cursor: pointer;
      transition: all 0.2s;
    `,n.addEventListener(`click`,()=>{this.currentFilter=t,(this.container?.querySelectorAll(`button`))?.forEach(t=>{t.textContent===e?(t.style.background=$.playerHex,t.style.color=`#000000`):(t.textContent?.includes(`הכל`)||t.textContent?.includes(`קרב`)||t.textContent?.includes(`עובד`))&&(t.style.background=`rgba(255, 255, 255, 0.2)`,t.style.color=`#ffffff`)}),this.renderAnimalList()}),n}renderSelectionDisplay(){let e=this.container?.querySelector(`#cage-selection-display`);if(!e)return;e.innerHTML=``;let t=this.createSelectionSlot(1,this.selectedAnimal1);e.appendChild(t);let n=document.createElement(`div`);n.textContent=`+`,n.style.cssText=`
      font-size: 72px;
      font-weight: bold;
      color: ${$.playerHex};
      display: flex;
      align-items: center;
      justify-content: center;
    `,e.appendChild(n);let r=this.createSelectionSlot(2,this.selectedAnimal2);e.appendChild(r);let i=document.createElement(`div`);if(i.textContent=`→`,i.style.cssText=`
      font-size: 72px;
      font-weight: bold;
      color: ${$.playerHex};
      display: flex;
      align-items: center;
      justify-content: center;
    `,e.appendChild(i),this.selectedAnimal1&&this.selectedAnimal2){let t=Il.createHybrid(this.selectedAnimal1,this.selectedAnimal2),n=this.createHybridResultSlot(t);e.appendChild(n)}else{let t=document.createElement(`div`);t.style.cssText=`
        width: 200px;
        height: 280px;
        ...
        font-size: 18px;
        text-align: center;
      `,t.textContent=`?`,e.appendChild(t)}}createSelectionSlot(e,t){let n=document.createElement(`div`);if(n.style.cssText=`
      width: 200px;
      height: 280px;
      border: 3px solid ${t?$.playerHex:`rgba(255, 255, 255, 0.3)`};
      border-radius: 12px;
      background: rgba(0, 0, 0, 0.5);
      padding: 15px;
      display: flex;
      ...
      transition: all 0.2s;
    `,t){n.style.boxShadow=`0 0 20px ${$.player}40`;let r=document.createElement(`div`);r.textContent=t.nameHebrew,r.style.cssText=`
        font-size: 20px;
        font-weight: bold;
        color: ${$.playerHex};
        margin-bottom: 15px;
        text-align: center;
      `,n.appendChild(r);let i=document.createElement(`div`);i.style.cssText=`
        font-size: 14px;
        color: #ffffff;
        line-height: 1.8;
      `,i.innerHTML=`
        <div>HP: ${t.hp}</div>
        <div>מהירות: ${t.speed}</div>
        <div>תקיפה: ${t.attack}</div>
        <div>טווח: ${t.range}</div>
        <div style="margin-top: 10px; color: #9b59b6;">DNA: ${t.costDNA}</div>
        <div style="color: #22C55E;">ביומסה: ${t.costBiomass}</div>
      `,n.appendChild(i);let a=document.createElement(`button`);a.textContent=`נקה`,a.style.cssText=`
        margin-top: 15px;
        padding: 8px 20px;
        background: #EF4444;
        color: #ffffff;
        ...
        font-size: 14px;
        font-weight: bold;
      `,a.addEventListener(`click`,t=>{t.stopPropagation(),e===1?this.selectedAnimal1=null:this.selectedAnimal2=null,this.renderSelectionDisplay()}),n.appendChild(a)}else{let t=document.createElement(`div`);t.textContent=`בחר חיה ${e}`,t.style.cssText=`
        font-size: 18px;
        color: rgba(255, 255, 255, 0.5);
      `,n.appendChild(t)}return n}createHybridResultSlot(e){let t=document.createElement(`div`);t.style.cssText=`
      width: 200px;
      height: 280px;
      border: 3px solid ${$.playerHex};
      border-radius: 12px;
      ...
      align-items: center;
      justify-content: center;
      box-shadow: 0 0 30px ${$.player}60;
    `;let n=document.createElement(`div`);n.textContent=e.name,n.style.cssText=`
      font-size: 20px;
      font-weight: bold;
      color: ${$.playerHex};
      margin-bottom: 15px;
      text-align: center;
    `,t.appendChild(n);let r=document.createElement(`div`);r.style.cssText=`
      font-size: 14px;
      color: #ffffff;
      line-height: 1.8;
    `,r.innerHTML=`
      <div>HP: ${e.hp}</div>
      <div>מהירות: ${e.speed}</div>
      <div>תקיפה: ${e.attack}</div>
      <div>טווח: ${e.range}</div>
      <div style="margin-top: 10px; color: #9b59b6;">DNA: ${e.costDNA}</div>
      <div style="color: #22C55E;">ביומסה: ${e.costBiomass}</div>
    `,t.appendChild(r);let i=document.createElement(`button`);return i.textContent=`התחל קרב`,i.style.cssText=`
      margin-top: 15px;
      padding: 12px 30px;
      background: ${$.playerHex};
      color: #000000;
      ...
      font-weight: bold;
      transition: all 0.2s;
    `,i.addEventListener(`mouseenter`,()=>{i.style.transform=`scale(1.1)`}),i.addEventListener(`mouseleave`,()=>{i.style.transform=`scale(1)`}),i.addEventListener(`click`,()=>{this.onStartBattle&&(this.onStartBattle(e),this.hide())}),t.appendChild(i),t}renderAnimalList(){let e=this.container?.querySelector(`#cage-animal-list`);if(!e)return;e.innerHTML=``;let t=Pl;if(this.currentFilter!==`all`&&(t=t.filter(e=>e.role===this.currentFilter)),this.searchQuery&&(t=t.filter(e=>e.nameHebrew.toLowerCase().includes(this.searchQuery)||e.name.toLowerCase().includes(this.searchQuery))),t.sort((e,t)=>e.costDNA===t.costDNA?e.nameHebrew.localeCompare(t.nameHebrew):e.costDNA-t.costDNA),t.length===0){let t=document.createElement(`div`);t.textContent=`לא נמצאו תוצאות`,t.style.cssText=`
        grid-column: 1 / -1;
        text-align: center;
        padding: 40px;
        font-size: 24px;
        color: rgba(255, 255, 255, 0.5);
      `,e.appendChild(t);return}for(let n of t){let t=this.createAnimalCard(n);e.appendChild(t)}}createAnimalCard(e){let t=this.selectedAnimal1===e||this.selectedAnimal2===e,n=document.createElement(`div`);n.style.cssText=`
      background: ${t?`rgba(45, 212, 191, 0.3)`:`rgba(0, 0, 0, 0.6)`};
      border: 2px solid ${t?$.playerHex:`rgba(255, 255, 255, 0.2)`};
      border-radius: 12px;
      padding: 15px;
      cursor: ${t?`default`:`pointer`};
      transition: all 0.2s;
      ${t?`box-shadow: 0 0 20px ${$.player}40;`:``}
    `,t||(n.addEventListener(`mouseenter`,()=>{n.style.borderColor=$.playerHex,n.style.background=`rgba(45, 212, 191, 0.1)`}),n.addEventListener(`mouseleave`,()=>{n.style.borderColor=`rgba(255, 255, 255, 0.2)`,n.style.background=`rgba(0, 0, 0, 0.6)`}),n.addEventListener(`click`,()=>{this.selectedAnimal1?!this.selectedAnimal2&&this.selectedAnimal1!==e&&(this.selectedAnimal2=e):this.selectedAnimal1=e,this.renderSelectionDisplay(),this.renderAnimalList()}));let r=document.createElement(`div`);r.textContent=e.nameHebrew,r.style.cssText=`
      font-size: 18px;
      font-weight: bold;
      color: ${t?$.playerHex:`#ffffff`};
      margin-bottom: 8px;
    `,n.appendChild(r);let i=document.createElement(`div`);i.textContent=e.name,i.style.cssText=`
      font-size: 12px;
      color: rgba(255, 255, 255, 0.6);
      margin-bottom: 10px;
    `,n.appendChild(i);let a=document.createElement(`div`);a.style.cssText=`
      font-size: 13px;
      color: #ffffff;
      line-height: 1.6;
    `,a.innerHTML=`
      <div>HP: ${e.hp} | מהירות: ${e.speed}</div>
      <div>תקיפה: ${e.attack} | טווח: ${e.range}</div>
      <div style="margin-top: 8px;">
        <span style="color: #9b59b6;">DNA: ${e.costDNA}</span> | 
        <span style="color: #22C55E;">ביומסה: ${e.costBiomass}</span>
      </div>
    `,n.appendChild(a);let o=document.createElement(`div`);if(o.textContent=e.role===`combat`?`⚔️ קרב`:`🔧 עובד`,o.style.cssText=`
      margin-top: 8px;
      font-size: 12px;
      color: ${e.role===`combat`?`#EF4444`:`#FACC15`};
      font-weight: bold;
    `,n.appendChild(o),t){let e=document.createElement(`div`);e.textContent=`✓ נבחר`,e.style.cssText=`
        margin-top: 8px;
        padding: 4px 10px;
        background: ${$.playerHex};
        color: #000000;
        ...
        font-weight: bold;
        text-align: center;
      `,n.appendChild(e)}return n}hide(){this.container&&=(document.body.removeChild(this.container),null)}},Ul=null,Wl=null,Gl=new Hl;function Kl(){let e=document.createElement(`div`);e.id=`splash-screen`,e.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
    ...
    font-family: Arial, sans-serif;
    direction: rtl;
  `;let t=document.createElement(`div`);t.textContent=`כִּימֵרָה`,t.style.cssText=`
    font-size: 72px;
    font-weight: bold;
    color: #2DD4BF;
    margin-bottom: 40px;
    text-shadow: 0 0 20px rgba(45, 212, 191, 0.5);
  `,e.appendChild(t);let n=document.createElement(`div`);n.textContent=`מלחמת קרב תלת-ממדית`,n.style.cssText=`
    font-size: 24px;
    color: #ffffff;
    margin-bottom: 60px;
  `,e.appendChild(n);let r=document.createElement(`div`);r.style.cssText=`
    display: flex;
    gap: 30px;
  `;let i=document.createElement(`button`);i.textContent=`כלוב - בחר חיות`,i.style.cssText=`
    padding: 20px 40px;
    font-size: 24px;
    font-weight: bold;
    background: #2DD4BF;
  ...
  `,i.addEventListener(`mouseenter`,()=>{i.style.transform=`scale(1.05)`,i.style.boxShadow=`0 6px 30px rgba(45, 212, 191, 0.6)`}),i.addEventListener(`mouseleave`,()=>{i.style.transform=`scale(1)`,i.style.boxShadow=`0 4px 20px rgba(45, 212, 191, 0.4)`}),i.addEventListener(`click`,()=>{e.style.opacity=`0`,e.style.transition=`opacity 0.5s`,setTimeout(()=>{e.remove(),ql()},500)}),r.appendChild(i);let a=document.createElement(`button`);a.textContent=`קרב מהיר`,a.style.cssText=`
    padding: 20px 40px;
    font-size: 24px;
    font-weight: bold;
    background: #64748B;
  ...
  `,a.addEventListener(`mouseenter`,()=>{a.style.transform=`scale(1.05)`,a.style.boxShadow=`0 6px 30px rgba(100, 116, 139, 0.6)`}),a.addEventListener(`mouseleave`,()=>{a.style.transform=`scale(1)`,a.style.boxShadow=`0 4px 20px rgba(100, 116, 139, 0.4)`}),a.addEventListener(`click`,()=>{e.style.opacity=`0`,e.style.transition=`opacity 0.5s`,setTimeout(()=>{e.remove(),Jl(null)},500)}),r.appendChild(a),e.appendChild(r);let o=document.createElement(`div`);o.textContent=`טוען...`,o.style.cssText=`
    margin-top: 40px;
    font-size: 18px;
    color: #94a3b8;
  `,e.appendChild(o),document.body.appendChild(e),setTimeout(()=>{o.style.display=`none`},1e3)}function ql(){Wl&&(Wl.style.display=`none`),Gl.show(e=>{Jl(e)})}function Jl(e){Gl.hide(),Wl?Wl.style.display=`block`:(Wl=document.createElement(`div`),Wl.id=`threejs-container`,Wl.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
      height: 100%;
      overflow: hidden;
    `,document.body.appendChild(Wl)),Ul&&Ul.dispose(),Ul=new Vl(Wl),Ul.start(e)}window.addEventListener(`navigate-to-cage`,()=>{ql()}),Kl(),document.addEventListener(`visibilitychange`,()=>{document.hidden});
//# sourceMappingURL=index-C7o6aVTs.js.map